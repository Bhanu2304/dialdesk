...
class CloseDetailsController extends AppController{
    ...
    public function view_close_fields() {
        ...
        $fieldSearch = array_merge(array('Id','SrNo','MSISDN','Category1','Category2','Category3','Category4','Category5'),$headervalue,
                array('LeadId','CallType', 'CallDate','CloseLoopCate1','CloseLoopCate2','closelooping_remarks','CloseLoopingDate','FollowupDate','tat','duedate','callcreated','CloseLoopStatus','CFieldUpdate','AWBNo','Ret_AWBNo','Ret_DestinationLocation'));
