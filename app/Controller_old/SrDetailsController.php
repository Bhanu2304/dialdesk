...
class SrDetailsController extends AppController{
	...
	$clientId = $this->Session->read('companyid');
        ...
        $fieldSearch = array_merge(array('Id','SrNo','MSISDN','Category1','Category2','Category3','Category4','Category5'),$headervalue,$headervalue1,
                array('LeadId','CallType','CallDate','CloseLoopCate1','CloseLoopCate2','closelooping_remarks','CloseLoopingDate','FollowupDate','tat','duedate','callcreated','AbandStatus','AWBNo','TokenNumber','Ret_AWBNo','Ret_TokenNumber','Ret_PikupDate','AreaPincode'));
