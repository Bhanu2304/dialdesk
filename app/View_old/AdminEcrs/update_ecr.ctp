...
$(document).ready(function(){
	...
	$.post("editget_label2",{parent_id : $('#cat2').val()},function(data,status){
            $('#abc').html(data);
        });
    });
	...
	$.post("editget_label2_sub1",{
		...
		function(data,status){
			 $('#type1').replaceWith(data);
                         $('#abd').html("");
			 //$('#sub_type1').replaceWith('<select name="data[Ecr][sub_type1]" id="sub_type1" required="required"></select>');
			})})});
//end
    ...
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">
                ...
                <?php echo $this->Form->create('AdminEcrs',array('action'=>'update_ecr','id'=>'editecr_form')); ?>
                ...
                <table class="display table table-bordered table-condensed table-hovered sortableTable"> 
                    <tr>
                        <td>
                            <?php echo $this->Form->create('AdminEcrs',array('action'=>'update_category')); ?>
                                <h6>Edit Category</h6>
                            ...
                            <td>
                            <?php echo $this->Form->create('AdminEcrs',array('action'=>'update_type')); ?>
                                <h6>Edit Type</h6>
                                <table class="display table  table-condensed table-hovered sortableTable">
                                    <tr>
                                        <td>
		...
		?>
                <div id="abc"></div>
                    <?php }?>
                        ...
                        <td>
                            <?php echo $this->Form->create('AdminEcrs',array('action'=>'update_sub_type1')); ?>
		  ...
		  ?>
                    ...
                    <div id="abd"></div>
                     <?php }?>
                        ...
                        <td>
                            <?php echo $this->Form->create('AdminEcrs',array('action'=>'update_sub_type2')); ?>
		...
		$category = isset($Category['1'])?$Category['1']:'';
		  ...
		  ?>
                    ...
                    <?php }?>
                        ...
                        <td>
                            <?php echo $this->Form->create('AdminEcrs',array('action'=>'update_sub_type3')); ?>
