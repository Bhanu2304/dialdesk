...
function viewReport(type){
    ...
    if(fdate ==""){
       ...
       return false;
        ...
        $.post('<?php echo $this->webroot?>Reports/view_agentwise',{fdate:fdate,ldate:ldate},function(data){
           $("#showCallReport").show();
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Agent Wise Call Tagging</a></li>
</ol>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Agent Wise Call Tagging Report</h2>
                <div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div>
            </div>
            <div data-widget-controls="" class="panel-editbox"></div>
            <div class="panel-body">
                <form method="post" action="<?php echo $this->webroot;?>Reports/agentwise"  class="form-horizontal row-border" >
