...
if(!empty($fieldName)){
    ...
    $numeric       =  $fieldName['ObfieldCreation']['FieldValidation']=='Numeric'?'checked = "checked"':'';
    $char          = $fieldName['ObfieldCreation']['FieldValidation']=='Char'?'checked = "checked"':'';
    $alphaNumeric  = $fieldName['ObfieldCreation']['FieldValidation']=='Alphanumeric'?'checked = "checked"':'';
    $Datepicker    = $fieldName['ObfieldCreation']['FieldValidation']=='Datepicker'?'checked = "checked"':'';
    
    
    
    
    
    $dropField=$fieldName['ObfieldCreation']['FieldType'];
...
?>
<?php echo $this->Form->create('ObclientFields',array('action'=>'update','class'=>"form-horizontal row-border")); ?>
                ...
                <div class="tab-pane active" id="horizontal-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="radio radio-inline radio-primary redio-left"  >
                                <label>
                                    <input type="radio" name="data[ObclientFields][FieldType]" id="ClientFieldsFieldTypeTextBox" <?php echo $textbox;?> value="TextBox" required="required" onclick="openCloseFields('0','edit')">
                                    Text Box
                                </label>
                            </div>
                            <div class="radio radio-inline radio-primary redio-left">
                                <label>
                                    <input type="radio" name="data[ObclientFields][FieldType]" id="ClientFieldsFieldTypeTextBox" <?php echo $textArea;?> value="TextArea" required="required" onclick="openCloseFields('0','edit')">
                                    Text Area
                                </label>
                            </div>
                            <div class="radio radio-inline radio-primary redio-left">
                                <label>
                                    <input type="radio" name="data[ObclientFields][FieldType]" id="ClientFieldsFieldTypeTextBox" <?php echo $dropDown;?> value="DropDown" required="required" onclick="openCloseFields('1','edit')">
                                    Drop Down
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="radio radio-inline radio-primary redio-left">
				<label>
                                    <input type="radio" name="data[ObclientFields][FieldValidation]" id="ClientFieldsFieldValidation" <?php echo $numeric;?>  value="Numeric"> Numeric
				</label>
                          </div>
                          <div class="radio radio-inline radio-primary redio-left" >
				<label>
                                    <input type="radio" name="data[ObclientFields][FieldValidation]" id="ClientFieldsFieldValidation" <?php echo $char;?> value="Char"> Character
				</label>
                          </div>
                            
                          <div class="radio radio-inline radio-primary redio-left" >
				<label>
                                    <input type="radio" name="data[ObclientFields][FieldValidation]" id="ClientFieldsFieldValidation" <?php echo $alphaNumeric;?> value="Alphanumeric"> Alphanumeric
				</label>
                          </div>
                            
                          <div class="radio radio-inline radio-primary redio-left" >
				<label>
                                    <input type="radio" name="data[ObclientFields][FieldValidation]" id="ClientFieldsFieldValidation" <?php echo $Datepicker;?> value="Datepicker"> Datepicker
				</label>
                          </div>
