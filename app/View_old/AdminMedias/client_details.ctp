                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" >
                    <tr>
                		<td>
      						...
      						<?php echo $this->Form->input('auth_person',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:150px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['auth_person']) ? $data['RegistrationMaster']['auth_person'] : ""));?> 
                     	</td>
                     	<td>
                     	...
                     	<td>
                      	...
                      	<td>
      						...
      						<?php echo $this->Form->input('email',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:150px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['email']) ? $data['RegistrationMaster']['email'] : ""));?> 
                     	</td>    
                     	<td>
