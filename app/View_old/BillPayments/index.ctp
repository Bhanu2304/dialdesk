...
function getPaymentDetals(ClientId){
    window.location.href = "<?php echo $this->webroot;?>BillPayments/?cid="+ClientId;
}
            ...
            <div class="panel-body">
                 <?php echo $this->Form->create('BillPayments',array('action'=>'payment_submition')); ?> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <?php echo $this->Form->input('ClientId',array('label'=>false,'options'=>$ClientName,'empty'=>'Select Client','value'=>isset($BillClient)?$BillClient:"",'onchange'=>'getPaymentDetals(this.value)','id'=>'ClientId','class'=>'form-control','required'=>true));?>
                        </div>
