...
<body style="font-size:12px;  font-family:Arial, Helvetica, sans-serif;">
    ...
    <div class="topright">
        ...
        <p>Bill Period:<span style="margin-left:30px;"><?php echo $BillMaster['0']['0']['BillStartDate'].'  To  '.$BillMaster['0']['0']['BillStartDate']; ?></span></p>
            ...
            <tr>
                <td align="center" colspan="3">
                    <table class="gridtable" cellspacing="0" cellpadding="1" align ="center">
                        ...
                        <tr>
                            <td id="t02" align ="center"><b><?php echo ($BillMaster['0']['post_bill_master']['LastCarriedAmount']+$BillMaster['0']['post_bill_master']['LastBilled']);?></b></td>
                            <td>&nbsp;-&nbsp;</td>
                            ...
                            <td>&nbsp;&nbsp;</td>
                            <td id="t02" align ="center"><b><?php echo $BillMaster['0']['post_bill_master']['LastBilled'];?></b></td> 
                            <td>&nbsp;=&nbsp;</td>
                            <td id="t02" align ="center" style="color:blue"><b><?php echo ($BillMaster['0']['post_bill_master']['LastCarriedAmount']+$BillMaster['0']['post_bill_master']['LastBilled']-$BillMaster['0']['post_bill_master']['paymentPaid']-$BillMaster['0']['post_bill_master']['Adjustments']);?></b></td>
                            <td id="t02" align ="center" style="color:blue"><b><?php echo $BillMaster['0']['0']['DueDate'];?></b></td>
                            <td id="t02" align ="center" style="color:blue"><b><?php echo ($BillMaster['0']['post_bill_master']['LastCarriedAmount']+$BillMaster['0']['post_bill_master']['LastBilled']-$BillMaster['0']['post_bill_master']['paymentPaid']-$BillMaster['0']['post_bill_master']['Adjustments']+100);?></b></td>
                        </tr>    
                    </table>
                </td>
            </tr>
                ...
                <td colspan="2">
                    <table class="gridtable" cellspacing="0" cellpadding="1" width = "300" style="font-size:10px;font-family:Arial,Helvetica, sans-serif;">
                        ...
                        <tr>
                            ...
                            <td id="t04"></td>
                            <td id="t04"  align="right"><b><?php echo $BillMaster['0']['post_bill_master']['LastCarriedAmount']; ?></b></td>
                        </tr>
                        <tr>
                            <td id="3"><b>Monthly Charges</b></td>
                            <td id="t04"><?php echo $BillMaster['0']['post_bill_master']['LastBilled'];?></td>
                        ...
                        <tr>
                            ...
                            <td id="t04"></td>
                            <td id="t04"  align="right"><b><?php echo $BillMaster['0']['post_bill_master']['LastBilled'] + $BillMaster['0']['post_bill_master']['LastCarriedAmount'];?></b></td>
                        </tr>
                    </table>
                </td>
                <td align="left">
