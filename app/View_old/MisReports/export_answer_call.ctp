...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/answer_call');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/export_answer_call');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Answer Call MIS</a></li>
</ol>
<div class="page-heading">            
    <h1>Answer Call MIS</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Answer Call MIS</h2>
            </div>
