        			...
        			<tr>
                		<td>
                        	<?php echo $this->Form->hidden('company_id',array('label'=>false,'value'=>isset ($data['RegistrationMaster']['company_id']) ? $data['RegistrationMaster']['company_id'] : ""));?> 
      						...
      						<?php echo $this->Form->input('company_name',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:175px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['company_name']) ? $data['RegistrationMaster']['company_name'] : ""));?> 
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" >
                    <tr>
                		<td>
      						...
      						<?php echo $this->Form->input('auth_person',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:175px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['auth_person']) ? $data['RegistrationMaster']['auth_person'] : ""));?> 
                     	</td>
                     	<td>
                     		
                                <span style="color: #616161;">Designation</span> 
      						<?php echo $this->Form->input('designation',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:175px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['designation']) ? $data['RegistrationMaster']['designation'] : ""));?> 
                    	</td>   
                     	<td>
                     		 <span style="color: #616161;">Phone No<font>*</font></span> 
      						<?php echo $this->Form->input('phone_no',array('label'=>false,'class'=>'form-control','onkeypress'=>'return checkCharacter(event,this)','maxlength'=>'10','style'=>'width:175px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['phone_no']) ? $data['RegistrationMaster']['phone_no'] : ""));?> 
                    	</td> 
                      	<td>
                       		<span style="color: #616161;">Email<font>*</font></span>  
      						<?php echo $this->Form->input('email',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:175px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['email']) ? $data['RegistrationMaster']['email'] : ""));?> 
                     	</td>    
                     	<td>
                       		<span style="color: #616161;">Password<font>*</font></span> 
      						<?php echo $this->Form->input('password',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:175px;','readonly'=>'readonly','value'=>isset ($data['RegistrationMaster']['password']) ? $data['RegistrationMaster']['password'] : ""));?> 
                     	</td>  
                 	</tr>
				</table>
                		...
                		<td>
                     	...
                     	<td>
                      	...
                      	<td>
      						...
      						<?php echo $this->Form->textarea('comm_address1',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:200px;height:50px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['comm_address1']) ? $data['RegistrationMaster']['comm_address1'] : ""));?> 
                     	</td>
                      	<td>
                       		<span style="color: #616161;">Communication Office Address 2</span> 
      						<?php echo $this->Form->textarea('comm_address2',array('label'=>false,'class'=>'form-control','maxlength'=>'255','style'=>'width:200px;height:50px;','readonly'=>$readonly,'value'=>isset ($data['RegistrationMaster']['comm_address2']) ? $data['RegistrationMaster']['comm_address2'] : ""));?> 
                    	</td>
                 	</tr>
				</table>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" >
                    <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                             <td><input type="file" multiple="multiple" name="userfile[]" id="upload_doc" style="width:190px;" /></td> 
                             <td><input type="file" multiple="multiple" name="userfile2[]" id="upload_doc2" style="width:190px;" /></td>
                             <td><input type="file" multiple="multiple" name="userfile3[]" id="upload_doc3" style="width:190px;" /></td> 
                             <td><input type="file" multiple="multiple" name="userfile4[]" id="upload_doc4"  style="width:190px;" /></td>
                             <td><input type="file" multiple="multiple" name="userfile5[]" id="upload_doc5"  style="width:190px;" /></td>
                        </tr>
                        <?php }?> 
                                ...
                                foreach(explode(",",$data['RegistrationMaster']['incorporation_certificate']) as $row1){?>
                              	<tr>
                                	<td>
                                        ...
                                        <?php }else{?>
                                        <img class="fancybox imgset" src="https://thetechtemple.com/wp-content/themes/TechNews/images/img_not_available.png"  />
                                        <?php }?>
                                    </td>
                         ...
                         <table>
                            <tr>
                                <td>
                                    ...
                                    <input type="radio" name="data[permission]"   <?php if(isset($data['RegistrationMaster']['status']) && $data['RegistrationMaster']['status'] =="D" ){echo "checked='checked'";} ?> value="D"  > Deactive
                                </td>
                            </tr>
                            <tr>
                            <td>
