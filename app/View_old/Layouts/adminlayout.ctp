...
<header id="topnav" class="navbar navbar-bleachedcedar navbar-fixed-top" role="banner">
	...
	<ul class="nav navbar-nav toolbar pull-right">
        ...
        <li class="dropdown toolbar-icon-bg">
            ...
            <div class="dropdown-menu animated notifications" style="height: 115px;" >		                
                        <div class="scroll-pane">
                            <ul class="media-list scroll-content"> 			
                                <li class="media notification-success">
                                    <a href="#">
                                        ...
                                        <div class="media-body">
                                            <h4 class="notification-heading">Admin</h4>  
                                        </div>
                                    </a>
                                </li>
...
<div id="wrapper">
	...
	<ul class="acc-menu">
            ...
            <li><a  class="withripple" href="<?php echo $this->webroot?>AdminDetails"><span class="icon">
                <i class="material-icons">home</i></span><span>Dashboard</span><span class="badge badge-teal"></span></a>
            </li>
            ...
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Plan Master</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminPlans"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Add / View Campaign</span></a></li>  
            ...
            <!--
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>IVR Creation</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminIvrs"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>IVR</span></a></li>                 
                </ul>
            </li>
            
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Inbound Process</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminEcrs"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Add ECR</span></a></li>  
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminEcrs/update_ecr"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>>Edit ECR</span></a></li> 
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminclientFields"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Capture Fields</span></a></li> 
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminclientFields/view"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>View Capture Fields</span></a></li> 
                </ul>
            </li>
            
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Outbound Process</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminCampaigns"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Add / View Campaign</span></a></li>  
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminCampaigns/import_export_campaign"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Import / Export Campaign Data</span></a></li> 
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdmindataAllocations"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Data Allocation</span></a></li> 
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminObecrs"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>ECR</span></a></li> 
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminObecrs/view"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>View ECR</span></a></li>  
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminobecrEdits"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Edit ECR</span></a></li> 
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminobclientFields"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Capture Fields</span></a></li> 
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminobclientFields/view"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>View Capture Fields</span></a></li> 
                </ul>
            </li>
            ...
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Plan Master</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminPlans"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Add / View Campaign</span></a></li>  
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminPlans/view_client_plan"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Import / Export Campaign Data</span></a></li> 
                </ul>
            </li>
            
            
            
             <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Training</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminTrainings"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Training</span></a></li>  
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminTrainings/view"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Training Details</span></a></li> 
                </ul>
            </li>
     
            
             <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Esclation</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminEscalations"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Add Esclation</span></a></li>  
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminEscalations/view"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>View  Esclation</span></a></li> 
                </ul>
            </li>
            
             <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>SR Reports </span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminsrDetails"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Inbound SR Reports</span></a></li>  
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdminobsrDetails"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Outbound SR Reports</span></a></li> 
                </ul>
            </li>
            
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Billing & Payment </span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href=<?php echo $this->webroot;?>Billingpayments"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Export Billing/Payment</span></a></li>  
