...
<div id="wrapper">
	...
	<ul class="acc-menu">
            ...
            <li><a  class="withripple" href="<?php echo $this->webroot?>homes"><span class="icon">
             ...
             <?php if($this->Session->read('admin_name') ==="tl"){?>
                ...
                <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="material-icons">call</i></i></span><span>Agent Calling Allocation</span></a>
                    <ul class="acc-menu">
                        <li><a  class="withripple" href="<?php echo $this->webroot;?>AdmindataAllocations"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>PD Call Allocation</span></a></li>
                        <li><a  class="withripple" href="<?php echo $this->webroot;?>AbandCallAllocations"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Abend Call Allocation</span></a></li>

                    </ul>
                </li>

                <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Report/Renewal Plan</span></a>
                    <ul class="acc-menu">
			...
			<li><a  class="withripple" href="javascript:;"><span class="icon"><i class="material-icons">call</i></i></span><span>Agent Calling Allocation</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AdmindataAllocations"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>PD Call Allocation</span></a></li>
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>AbandCallAllocations"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Client Rights Allocation</span></a></li>
                    
                </ul>
            </li>
            
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="material-icons">messages</i></i></span><span>Bluedart Configuration</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>BluedartApis"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Upload Service Address</span></a></li>
                </ul>
            </li>
            ...
            <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="fa fa-user"></i></span><span>Report/Renewal Plan</span></a>
                <ul class="acc-menu">
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>Reports"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Call Tagging Summary</span></a></li>
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>Reports/agentwise"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Agent Wise Call Tagging</span></a></li>
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>BillSummarys/add"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Add Bill Summary Auto Mail</span></a></li>             
                    <li><a  class="withripple" href="<?php echo $this->webroot;?>BillSummarys"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Renewal Plan/Bill Summary</span></a></li>             
                </ul>
            </li>
             ...
             <?php if($this->Session->read('clientstatus') ==="A"){?>
                ...
                <?php if($this->Session->read('companyid') =="326"){?>
                <li><a  class="withripple" href="javascript:;"><span class="icon"><i class="material-icons">file_download</i></span><span>Manage Reports</span></a>
                    <ul class="acc-menu">
                        <li><a  class="withripple" href="<?php echo $this->webroot;?>ExicomReports"><span class='icon'><i class="fa fa-angle-right" aria-hidden="true"></i></span> <span>Reports</span></a></li>          
                    </ul>
                </li>
                <?php } ?>
                <?php echo $leftMenu; ?>
