...
function validateExport(){
        ...
        var fdate=$("#fdate").val();
        var ldate=$("#ldate").val();
        var campname=$("#ObExportReportsCampaignName").val();
        var alocname=$("#ObExportReportsAllocationName").val();
...
function get_allocation_data(path,camp){
        ...
        $.ajax({
                ...
                success:function(data){
                        $("#ObExportReportsAllocationName").html(data);
                }
        });	
}
</script>
                ...
                <div class="panel-body">
                    ...
                    <?php echo $this->Form->create('ObExportReports',array('action'=>'download','onsubmit'=>'return validateExport()','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-6">      
                      			<?php echo $this->Form->input('CampaignName',array('label'=>false,'onchange'=>'get_allocation_data("'.$this->webroot.'ObExportReports/get_allocation",this)','options'=>$Campaign,'empty'=>'Select Campaign','class'=>'form-control','required'=>true ));?>
                         	</div>
                		</div>
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-6">      
                      			<?php echo $this->Form->input('AllocationName',array('label'=>false,'onchange'=>'get_count("'.$this->webroot.'DataAllocations/get_count",this)','options'=>'','empty'=>'Select Allocation','class'=>'form-control','required'=>true ));?>
                         	</div>
                		</div>
