            ...
            <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                ...
                <div class="panel-body">
                    ...
                    <?php echo $this->Form->create('Outbounds',array('action'=>'add_campaign','enctype'=>'multipart/form-data','onsubmit'=>'return validate_campaign()','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>	
                        ...
                        <div class="form-group">
                            <div class="col-sm-5"> 
                            	<?php echo $this->Form->input('CampaignType',array('label'=>false,'options'=>array('dialdeskUser'=>'Manage By Dialdesk','clientUser'=>'Manage By Client'),'empty'=>'Select Type','onchange'=>'showListId(this.value)','class'=>'form-control','required'=>true ));?>     
                                <span style='color:red;font-size:12px;' >( Field name not required in Manage by client. )</span>
                            </div>
                	</div>
                        
                        <div class="form-group">
                            <div class="col-sm-5">  
                                <?php echo $this->Form->input('CampaignParentName',array('label'=>false,'options'=>$CampaignList,'empty'=>'Campaign Type','class'=>'form-control','required'=>true ));?>     
                    ...
                    <div class="form-group">
                        <div class="col-sm-5">   
                            <div class="field_wrapper">
                                <div>                                       
                                    <input type="text" name="field_name[]" placeholder="Field Name" class="form-control field_name" />
