...
<div class="page-heading margin-top-head">            
    ...
    <div >
       ...
       <?php echo $this->Form->input('clientID',array('label'=>false,'onchange'=>'createClientWaiver();','options'=>$client,'value'=>isset($clientid)?$clientid:"",'id'=>'slclient','empty'=>'Select Client','class'=>'form-control','required'=>true)); ?>
