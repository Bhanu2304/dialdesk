                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="horizontal-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <?php echo $this->Form->input('alertOn',array('label'=>false,'id'=>'EscalationsAlertOnEdit','value'=>isset($data1['alertOn'])?$data1['alertOn']:"",'class'=>'form-control','options'=>array('sms'=>'SMS','email'=>'Email','both'=>'Both'),'empty'=>'Select','required'=>true)); ?>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <?php echo $this->Form->input('email',array('label'=>false,'id'=>'EscalationsEmailEdit','value'=>isset($data1['email'])?$data1['email']:"",'class'=>'form-control','placeholder'=>'Email','required'=>false)); ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="horizontal-form">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-2 control-label">Alert On</label>
                            <div class="col-sm-4">
                                <?php echo $this->Form->input('alertOn',array('label'=>false,'id'=>'EscalationsAlertOnTab2Edit','value'=>isset($data1['alertOn'])?$data1['alertOn']:"",'class'=>'form-control','options'=>array('sms'=>'SMS','email'=>'Email','both'=>'Both'),'empty'=>'Select','required'=>true)); ?>
                            </div>
                            <label class="col-sm-2 control-label">Mobile No.</label>
                            <div class="col-sm-4">
