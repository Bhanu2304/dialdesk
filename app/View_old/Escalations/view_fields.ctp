                                        ...
                                        <div class="panel panel-default"   data-widget='{"draggable": "false"}'>   
                                            ...
                                            <?php echo $this->Form->create('Escalations',array('action'=>'save_alert_esclation','onsubmit'=>'return checkDefineAlert();','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <?php echo $this->Form->input('email',array('label'=>false,'class'=>'form-control','placeholder'=>'Email','required'=>false)); ?>
                                                    </div>
                                                    <!--
                                    ...
                                    <div class="panel-body" id="tab2"  >                            
                                        <div class="panel panel-default"   data-widget='{"draggable": "false"}'>  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-sm-2 control-label">Alert On</label>
                                                <div class="col-sm-2">
                                                    <?php echo $this->Form->input('alertOn',array('label'=>false,'id'=>'EscalationsAlertOnTab2','class'=>'form-control','options'=>array('sms'=>'SMS','email'=>'Email','both'=>'Both'),'empty'=>'Select','required'=>true)); ?>
                                                </div>
                                                <label class="col-sm-2 control-label">Mobile No.</label>
                                                <div class="col-sm-2">
                                                ...
                                                <label class="col-sm-2 control-label">Email</label>
                                                <div class="col-sm-2">
                                                    <?php echo $this->Form->input('email',array('label'=>false,'id'=>'EscalationsEmailTab2','class'=>'form-control','placeholder'=>'Email','required'=>false)); ?>
                                                </div>
