...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo $this->webroot;?>Ecrs">TAT Creation</a></li>                    
</ol> 
...
function getwcat(id,eid){
    if(id ==="Custom Hours"){
        $("#wstime"+eid).show();
        $("#wetime"+eid).show();
        $.post("<?php echo $this->webroot;?>Ecrs/start_time",{st:''},function(data){$("#wstime"+eid).html(data);});
        $.post("<?php echo $this->webroot;?>Ecrs/end_time",{et:''},function(data){$("#wetime"+eid).html(data);});   
    }
    else{
        $("#wstime"+eid).hide();
        $("#wetime"+eid).hide();
...
function editgetwcat(id,eid,st,et){
    if(id ==="Custom Hours"){
        
        $("#wstime"+eid).show();
        $("#wetime"+eid).show();
        $.post("<?php echo $this->webroot;?>Ecrs/start_time",{st:st},function(data){$("#wstime"+eid).html(data);});
        $.post("<?php echo $this->webroot;?>Ecrs/end_time",{et:et},function(data){$("#wetime"+eid).html(data);});   
    }
    else{
        $("#wstime"+eid).hide();
        $("#wetime"+eid).hide();
