...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Bot Chat Data</a></li>
</ol>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="exap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $post['BotMaster']['id']; ?></td>
                                <td><?php echo $post['BotMaster']['phone_no']; ?></td>
                                <td><?php echo $post['BotMaster']['type']; ?></td>
                                <td><?php echo $post['BotMaster']['request'];?></td>
                                <td><?php echo $post['BotMaster']['response'];?></td>
                                <td><?php echo $post['BotMaster']['Bot_options'];?></td>
                                <td>
                                    <a href="#" onclick="deleteData('<?php echo $this->webroot;?>BotMaster/delete_data?id=<?php echo $post['BotMaster']['id'];?>')" >
