   ...
   ?>
      ...
      <div style="margin-left:20px;">
         <div class="form-group">
            <?php echo $this->Form->create('Home',array('url'=>'/homesnew','id'=>'view_client_form')); ?>
            <div class="col-sm-3">
         ...
         <div id="home" class="tab-pane fade in <?php echo $tabactive_call;?>">
            ...
            <div class="page-heading">
                  ...
                  <?php
                     ...
                     ?>
                  <?php echo $this->Form->create('Home',array('url'=>'/homesnew'));?>
                           ...
                           <div data-widget-group="group1">
                              ...
                              <div class="row">
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-indigo">
                                       <div class="info">
                                          <div class="tile-heading"><span>Total Contacted Calls</span></div>
                                          <!-- <div class="tile-body"><span><?php echo empty($Answered)?0:$Answered; ?></span></div> -->
                                          <div class="tile-body"><span><?php echo empty($Answered)?0:$Answered; ?></span></div>
                                       </div>
                                       <div class="stats">
                                 ...
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-danger">
                                       <div class="info">
                                          <div class="tile-heading"><span>Total Not Contacted Calls</span></div>
                                          <!-- <div class="tile-body "><span><?php echo empty($Abandon)?0:$Abandon; ?></span></div> -->
                                          <div class="tile-body "><span><?php echo empty($Abandon)?0:$Abandon; ?></span></div>
                                       </div>
                                       <div class="stats">
                                       ...
                                       <div class="row text-center">
                                          ...
                                          <div class="col-md-4 col-sm-4 col-xs-12">
                                             <div class="about-move">
                                                   <div class="services-details">
                                                      <div class="single-services">
                                                         <canvas id="pieChart5" height="200"></canvas>
                                                      </div>
                                                   </div>
                                                   <!-- end about-details -->
                                             </div>
                                          ...
                                          <div class="col-md-4 col-sm-4 col-xs-12">
                                             ...
                                             <div class=" about-move">
                                                   <div class="services-details">
                                                      <div class="single-services">
                                                         <canvas id="pieChart6" height="200"></canvas>
                                                      </div>
                                                   </div>
                                                   <!-- end about-details -->
                                             </div>
                                          ...
                                          <div class="col-md-4 col-sm-4 col-xs-12">
                                             <div class="about-move">
                                                   <div class="services-details">
                                                      <div class="single-services">
                                                         <canvas id="pieChart7" height="200"></canvas>
                                                      </div>
                                                   </div>
                                                   <!-- end about-details -->
                                             </div>
                                          ...
                                          <div class="col-md-4 col-sm-4 col-xs-12">
                                             ...
                                             <div class=" about-move">
                                                   <div class="services-details">
                                                      <div class="single-services">
                                                         <canvas id="pieChart8" height="200"></canvas>
                                                      </div>
                                                   </div>
                                                   <!-- end about-details -->
                                             </div>
                                          ...
                                          <div class="col-md-4 col-sm-4 col-xs-12">
                                             <div class="about-move">
                                                   <div class="services-details">
                                                      <div class="single-services">
                                                         <canvas id="pieChart9" height="200"></canvas>
                                                      </div>
                                                   </div>
                                                   <!-- end about-details -->
                                             </div>
                                          ...
                                          <div class="col-md-4 col-sm-4 col-xs-12">
                                             ...
                                             <div class=" about-move">
                                                   <div class="services-details">
                                                      <div class="single-services">
                                                         <canvas id="pieChart10" height="200"></canvas>
                                                      </div>
                                                   </div>
                                                   <!-- end about-details -->
                                             </div>
                                          ...
                                          <div class="col-md-4 col-sm-4 col-xs-12">
                                             <div class="about-move">
                                                   <div class="services-details">
                                                      <div class="single-services">
                                                         <canvas id="pieChart11" height="200"></canvas>
                                                      </div>
                                                   </div>
                                                   <!-- end about-details -->
                                             </div>
                              ...
                              <script>
                                          ...
                                          var DoughtnutConfig = {
                                             ...
                                             data: {
                                                datasets: [{
                                                      data: [
                                                         <?php echo empty($Abandon)?0:$Abandon; ?>,
                                                         <?php echo empty($Answered)?0:$Answered; ?>,
                                                         0,
                                                      ],
                                                      backgroundColor: [
                                                         "#F7464A",
                                          ...
                                          var DoughtnutConfig1 = {
                                             ...
                                             data: {
                                                datasets: [{
                                                      data: [
                                                         <?php echo empty($NotContacted)?0:$NotContacted; ?>,
                                                         <?php echo empty($Contacted)?0:$Contacted; ?>,
                                                         190,
                                                      ],
                                                      backgroundColor: [
                                                         "#F7464A",
                                          ...
                                          var PieConfig4 = {
                                             ...
                                             data: {
                                                ...
                                                labels: [
                                                      "Call Back",
                                                      "Interested but in Follow Up",
                                                      "Addressable Concern 1",
                                                      "Addressable Concern 2",
                                          ...
                                          var PieConfig8 = {
                                             ...
                                             options: {
                                                ...
                                                title: {
                                                      display: true,
                                                      text: 'Workable Not Connected VoC- Today',
                                                      fontColor: ['rgba(0,0,0)'],
                                                      fontSize: 16,
                                          ...
                                          var PieConfig9 = {
                                             ...
                                             options: {
                                                ...
                                                title: {
                                                      display: true,
                                                      text: 'Workable Not Connected VoC- MTD',
                                                      fontColor: ['rgba(0,0,0)'],
                                                      fontSize: 16,
                                          ...
                                          var PieConfig10 = {
                                             ...
                                             data: {
                                                ...
                                                labels: [
                                                      "Wrong No",
                                                      "Incomplete No",
                                                      "Permanently switch off/not responding",
                                                      "Permanently out of coverage",
                                             ...
                                             options: {
                                                ...
                                                title: {
                                                      display: true,
                                                      text: 'Non- Workable Not Connected VoC- Today',
                                                      fontColor: ['rgba(0,0,0)'],
                                                      fontSize: 16,
                                          ...
                                          var PieConfig11 = {
                                             ...
                                             options: {
                                                ...
                                                title: {
                                                      display: true,
                                                      text: 'Non- Workable Not Connected VoC- MTD',
                                                      fontColor: ['rgba(0,0,0)'],
                                                      fontSize: 16,
                                          ...
                                          window.onload = function() 
                                          {
                                             ...
                                             window.myPie7 = new Chart(document.getElementById("pieChart7"), PieConfig7);
                                             window.myPie8 = new Chart(document.getElementById("pieChart8"), PieConfig8);
                                             window.myPie9 = new Chart(document.getElementById("pieChart9"), PieConfig9);
                                             window.myPie10 = new Chart(document.getElementById("pieChart10"), PieConfig10);
                                             window.myPie11 = new Chart(document.getElementById("pieChart11"), PieConfig11);
