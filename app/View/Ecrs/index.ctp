                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    ...
                                    <?php echo $this->Form->create('ScenarioReports',array('action'=>'export_inbound_scenario',"class"=>"form-horizontal row-border","id"=>"validate-form",'data-parsley-validate' )); ?>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Export Scenarios</label>
                                            <div class="col-sm-6">
