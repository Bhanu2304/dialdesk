                        ...
                        <div class="panel-body">
                            <div style="height:660px;overflow:scroll;width:448px;">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        <td>RECORDING</td>
                                        <td><a href="http://14.97.29.226/download-recording/download.php?mode=<?php echo $mode; ?>&filename=<?php echo $history['CallMaster']['LeadId'];?>"title="Download" ><label class="btn btn-xs tn-midnightblue btn-raised"><i class="fa fa-download"></i></label></a></td>
                                    </tr>
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary" >
                        ...
                        <div class="panel-body">
							...
							<script>
									function trackOrderId(orderId){
										$(".loader").show();
										$.get("<?php echo $this->webroot;?>app/webroot/crone/arbapi/tracking_order.php",{orderId:orderId}, function(result){
											$(".loader").hide();
											$("#orderStatus").html(result);
										});
									}
									...
									<div class="form-group" style="margin-top:-20px;" >
										...
										<?php if($this->Session->read('companyid') =="277" && $history['CallMaster']["Category1"] =="Return Request" && $history['CallMaster']["OrderNo"] !=""){?>
											|<a href="#" onclick="trackOrderId('<?php echo 'REV'.$history['CallMaster']["SrNo"];?>')"; >Rev Status </a> |
											<a href="#" onclick="hideOrder()"; >Hide </a>|
											<a href="<?php echo $this->webroot;?>CloseDetails/bluedartapi?lastid=<?php echo $callId;?>"  onclick="return confirm('Are you sure you want to generate order?');" >Create Order </a> |
											<a href="<?php echo $this->webroot;?>CloseDetails/bluedartapi?lastid=<?php echo $callId;?>"  onclick="return confirm('Are you sure you want to generate shipment?');" >Create Shipment</a> |	
										<?php }?>
										
										<?php if($this->Session->read('companyid') =="277" && $history['CallMaster']["Category1"] =="Return Request" && $history['CallMaster']["Ret_AWBNo"] !=""){?>
											<a href="#" onclick="trackOrderId('<?php echo 'PPD'.$history['CallMaster']["SrNo"];?>')"; >PPD Status </a>|
										<?php }?>
										
										</div>
										<div class="col-sm-2"  ><div class='loader' style='display:none;'></div></div>
										<div class="col-sm-12 pull-right" id="orderStatus"></div>
                            ...
                            <div style="height:660px;overflow:scroll;width:448px;">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"> 
									...
									<form action="<?php echo $this->webroot;?>CloseDetails/update_closeloop_image" method="post" enctype="multipart/form-data">
									<input type="hidden" name="call_master_id" value="<?php echo $history['CallMaster']['Id'];?>" >
									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
										<tr><th colspan="3">Upload Image</th></tr>
										<tr>
											<td>Image</td>
											<td><input type="file" name='banner' required style="width:200px;" ></td>
											<td><input type="submit" name="submit" value="Submit"   > </td>
										</tr>
										<?php $k=1; foreach($close_loop_image as $image){?>
										<tr><td><?php echo $k++;?></td></td><td><a target="_blank" href="<?php echo $this->webroot.'closeloopimage/'.$image['close_loop_image']['Image'];?>"><img src="<?php echo $this->webroot.'closeloopimage/'.$image['close_loop_image']['Image'];?>" style="width:50px;" ></a></td><td><a href="<?php echo $this->webroot;?>CloseDetails/delete_closeloop_image?Id=<?php echo $image['close_loop_image']['Id'];?>" onclick="return confirm('Are you sure you want to delete this item?');" >Delete</a></td></tr>
										<?php }?>
									</table>
									</form>
