                    ...
                    { //print_r($record);exit;
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td align="right" style="background: #EEE9E9;"><?php $Opening_ledger=$Opening_ledger+$op; $op =($record['ledger_access_usage']+$record['ledger_topup']+$record['ledger_sub']+$record['ledger_setup']);  echo number_format($op,2); ?></td>
