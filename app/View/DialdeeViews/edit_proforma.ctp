...
function delete_part2(id)
{
	var xmlHttpReq = false;	
				...
				xmlHttpReq.open('POST','/invoices/delete_particular?id='+id,true);
...
function get_part(particular,rate,qty,amount,initial_id)
{
    ...
    xmlHttpReq.open('POST','/invoices/add_part_ajax?particular='+particular+'&rate='+rate+'&qty='+qty+'&amount='+amount+'&initial_id='+initial_id,true);
    xmlHttpReq.send(null);
...
<?php echo $this->Form->create('InitialInvoice',array('class'=>'form-horizontal','action'=>'update_proforma')); ?>
    ...
    <div class="col-md-4">
            ...
            <table class="table"  style="margin-bottom:0px;">
                <tbody>
                    ...
                    <input type="date" id="FromDate" name="data[InitialInvoice][invoiceDate]" value="<?php echo $hide['invoiceDate'];?>" placeholder="First Date" required="" class="date-picker hasDatepicker">
                    
                </td>
            </tr>
                    <tr><th>Due Date</th><td> <?php	echo $this->Form->input('InitialInvoice.due_date', array('label'=>false,'value'=>$tbl_invoice['InitialInvoice']['due_date'],'required'=>false)); ?></td></tr>
			...
			<?php // echo $this->Form->create('Add',array('url'=>array('controller'=>'AddInvParticulars','action'=>'index'))); ?>
				...
				<div id="xx"><input type='hidden' value='0' id='par_total' name='par_total'></div>
						...
						<?php  foreach ($inv_particulars as $post): 
							...
							<td><?php echo $this->Form->input('Particular.'.$post['Particular']['id'].'.qty',array('label'=>false,'readonly'=>$edit_tail,'value'=>$post['Particular']['qty'],'onkeypress'=>'return isNumberKey(event)')); ?></td>
							<td><?php echo $this->Form->input('Particular.'.$post['Particular']['id'].'.rate',array('label'=>false,'readonly'=>$edit_tail,'value'=>$post['Particular']['rate'],'onBlur'=>'getAmount1(this.id)','onkeypress'=>'return isNumberKey(event)')); ?></td>
							...
							<td>  <button name = "Delete" class="btn btn-danger" value="<?php echo $post['Particular']['id']; ?>" onClick ="return deletes2(this.value)">Delete</button>  </td>
							</tr>
...
<div class="row">
    <div class="col-md-12">
                ...
                <tr><td></td><td><button type="submit" class="btn btn-success btn-label-left" onClick="return validate()"><b>Update</b></button></td></tr>
</table>
...
?>
<input type="hidden" value="<?php echo $tbl_invoice['InitialInvoice']['id']; ?>" name="initial_id" />
