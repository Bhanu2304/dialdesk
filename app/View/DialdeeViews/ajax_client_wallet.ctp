                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <select name="client" id="client" class="form-control">
                            ...
                            <?php foreach($client_list as $client2) {  ?>
                                
                                <option value="<?php echo $client2['DialdeeSharedRegistrationMaster']['company_id']; ?>" <?php if($company_id==$client2['DialdeeSharedRegistrationMaster']['company_id']) { echo 'selected';} ?>><?php  if(empty($client2['DialdeeSharedRegistrationMaster']['company_name'])) echo $client2['DialdeeSharedRegistrationMaster']['auth_person']; else echo $client2['DialdeeSharedRegistrationMaster']['company_name'] ; ?></option>
                            <?php } ?>      
                        </select>
                        </div>
                    </div>                
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="date" name="from_date" id="from_date" value="<?php echo $from_date; ?>" class="form-control date-picker1" required=""/>
                        </div>
                    </div>

                    <div class="col-md-2">
                        <div class="form-group">
                        <input type="date" name="to_date" id="to_date" value="<?php echo $to_date; ?>" class="form-control date-picker1" required=""/>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
...
<div class="col-md-12">                                                
                <table class="table" style="width:100%;font-size: 11px;">
                    <tr>
                        ...
                        <th colspan="7" class="left_bord" style="text-align: center;background: #FAEBEB;">Credit Point Consumption</th>
                    ...
                    <tr>
                        ...
                        <th  style="text-align:right;padding:2px;background: #FAEBEB;">Free Chat</th>
                        <th  style="text-align:right;padding:2px;background: #FAEBEB;">Consumed Chat</th>
                        <th  style="text-align:right;padding:2px;background: #FAEBEB;">Opening</th>
                        <th  style="text-align:right;padding:2px;background: #FAEBEB;">Fresh Release</th>
                    ...
                    foreach($color_array as $st=>$color)
                    {
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                $free_chat = $record['free_chat'];
                                $used_chat = $record['used_chat'];
                                ...
                                <td align="right" style="padding:2px; background-color:#FAEBEB;"><?php  echo $free_chat;    ?></td>
                                <td align="right" style="padding:2px;background-color:#FAEBEB; "><?php  echo $used_chat;    ?></td>
                                ...
                                <td align="right" style="padding:2px;background: #FAEBEB;" class="left_bord"><?php $bal = round($record['closing_credit'],2); #$bal = round($open_bal+$fr_val-$csbal,2); 
                                ...
                                $total_without_tax = 0;
                                $InChatCharge = $record['InChatCharge'];
                                if($bal<0)
                                {    $total_without_tax=round($bal*$InChatCharge,2);     }
                                ...
                                $exposure = $exp+$cl+$tobebilled;

                                $TOTAL_EXP =$TOTAL_EXP+$exposure;

                                echo number_format($exp+$cl+$tobebilled,2);
                                ...
                                $TO_BE_BILLED = $tobebilled2+$tobebilled;

                                $TOTAL_TO_BE_BILLED = $TOTAL_TO_BE_BILLED +$TO_BE_BILLED;
                                
                                ?>
                                </td> 
                                <td align="right" style="padding:2px;background: #EEE9E9;">
                                <?php  echo number_format($tobebilled2+$tobebilled,2); ?>
                                </td>
                                
                                <td style="padding:2px;background: #EEE9E9;" class="left_bord">
                                    
                                    <?php if($tobebilled2>1) { ?><?php echo $br;$br = "<br/>"; ?><a href="/invoices/add_bill_tool?cost_center=<?php echo $record['cost_center'];?>&bill_type=talk-time-tool&rate=<?php echo round($tobebilled2_without_tax,2); ?>&qty=<?php echo (-1*$bal); ?>&amt=<?php echo round($tobebilled2_without_tax,2);?>">Credit</a><?php } ?>
                                    
                                    <?php if($tobebilled>1) {  ?> <?php echo $br;$br = "<br/>"; ?>
                                    <a href="/invoices/add_bill_tool?cost_center=<?php echo $record['cost_center'];?>&bill_type=subs-tool&rate=<?php echo abs($tobebilled_without_tax);?>&sub_start_date=<?php echo $record['sub_start_date'];?>&sub_end_date=<?php echo $record['sub_end_date'];?>&due_date=<?php echo $record['due_date'];?>">Subscription</a>
                                    <?php }  ?>
                                ...
                                <!-- </td>
                                <td> -->
                                <?php if(  ($tobebilled2>0) || ($tobebilled>0)) { ?>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <th style="padding:2px;background: #FAEBEB;text-align: right;"></th>
                        <th style="padding:2px;background: #FAEBEB;text-align: right;"></th>
