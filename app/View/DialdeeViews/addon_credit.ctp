...
<ol class="breadcrumb">                                
    ...
    <li><a >Dialdee</a></li>
    <li class="active"><a href="<?php echo $this->webroot;?>Billing">Dialdee Exposure</a></li>
</ol>
<div class="page-heading">            
    <h1>Dialdee Exposure</h1>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="padding:2px;background: #EEE9E9;" class="left_bord">
                                    ...
                                    <?php if($tobebilled2>1) { ?><?php echo $br;$br = "<br/>"; ?><a href="/dialdesk/InitialInvoices/add_bill_tool?cost_center=<?php echo $record['cost_center'];?>&bill_type=talk-time-tool&rate=<?php echo $InChatCharge; ?>&qty=<?php echo (-1*$bal); ?>&amt=<?php echo round($tobebilled2_without_tax,2);?>">Credit</a><?php } ?>
                                    
                                    <?php if($tobebilled>1) {  ?> <?php echo $br;$br = "<br/>"; ?>
                                    <a href="/dialdesk/InitialInvoices/add_bill_tool?cost_center=<?php echo $record['cost_center'];?>&bill_type=subs-tool&rate=<?php echo abs($tobebilled_without_tax);?>&sub_start_date=<?php echo $record['sub_start_date'];?>&sub_end_date=<?php echo $record['sub_end_date'];?>&due_date=<?php echo $record['due_date'];?>">Subscription</a>
                                    <?php }  ?>
