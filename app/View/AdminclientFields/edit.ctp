    ...
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">
                ...
                <?php echo $this->Form->create('AdminclientFields',array('action'=>'update',"class"=>"form-horizontal row-border")); ?>
                       ...
                       <?php
                        if(isset($fieldValue))
                        {
                            ...
                            foreach($fieldValue as $post):
                                echo $this->Form->input('oldValues.'.$post['FieldValue']['id'],array('label'=>false,'value'=>$post['FieldValue']['FieldValueName'], 'required'=>true,'class'=>'form-control'))."<br/>";
                            endforeach;
                            echo '<td></tr>';
                        }
                        ?>                   
