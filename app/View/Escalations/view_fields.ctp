...
function checkDefineAlert(){
    var alertType=$("#EscalationsAlertOn").val();
    var mobil=$("#EscalationsMobileNo").val();
    var email=$("#EscalationsEmail").val();
    
    if(alertType ==="sms" &&  mobil ===""){
        alert('Please enter mobile no.');
        $("#EscalationsMobileNo").focus();
        return false;
    }
    else if(alertType ==="email" &&  email ===""){
        alert('Please enter email id.');
        $("#EscalationsEmail").focus();
        return false;
    }
...
function checkDefineEsclation(){
    var alertType=$("#EscalationsAlertOnTab2").val();
    var mobil=$("#EscalationsMobileNoTab2").val();
    var email=$("#EscalationsEmailTab2").val();
    
    if(alertType ==="sms" &&  mobil ===""){
        alert('Please enter mobile no.');
        $("#EscalationsMobileNoTab2").focus();
        return false;
    }
    else if(alertType ==="email" &&  email ===""){
        alert('Please enter email id.');
        $("#EscalationsEmailTab2").focus();
        return false;
    }
    else if(alertType ==="both" &&  mobil ===""){
        alert('Please enter mobile no.');
                                ...
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    ...
                                    <div class="panel-body" id="tab1"   >                                      
                                        <div class="panel panel-default"   data-widget='{"draggable": "false"}'>   
                                            ...
                                            <?php }?>
                                            <?php echo $this->Form->create('Escalations',array('action'=>'save_alert_esclation','onsubmit'=>'return checkDefineAlert();','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <?php echo $this->Form->input('email',array('label'=>false,'type'=>"textarea",'class'=>'form-control','placeholder'=>'Email','required'=>false)); ?>
                                                    </div>
                                                    <!--
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    ...
                                    <div class="panel-body" id="tab5">                 
                                         <div class="panel panel-default"   data-widget='{"draggable": "false"}'>  
                                        <?php if(isset($tab) && $tab ==="tab5"){?>
                                                <div style="color:green;margin-left:75px;margin-top: 5px;"><?php echo $this->Session->flash(); ?></div>
                                            <?php }?>
                                            <?php echo $this->Form->create('Escalations',array('action'=>'save_customer_whasaaptext','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                                                                       
                                            <?php echo $this->Form->hidden('tabType',array('label'=>false,'class'=>'form-control','value'=>'tab5')); ?>
                                           
                                        <div class="form-group">
                                            
                                            
                                        <?php echo $this->Form->input('alert_type',array('label'=>false,'class'=>'form-control','value'=>'Alert','type'=>'hidden')); ?>
                                            
                                            <label class="col-sm-2 control-label"><b>Scenario</b></label>
                                            <div class="col-sm-2">
                                                <?php echo $this->Form->input('category',array('label'=>false,'class'=>'form-control','options'=>$category,'empty'=>'Select','onchange'=>"getType(this.value,'".$this->webroot."escalations/getEcr','sas')",'required'=>true)); ?>
                                            </div>
                                            <div id="sastype"></div>
                                            <div id="sassubtype"></div>
                                        </div>
                                        <div class="row">
                                                     <div class="col-sm-12">
                                             <div id="sassubtype1"></div>
                                            <div id="sassubtype2"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <?php echo $this->Form->input('api_key',array('type'=>'text','label'=>false,'class'=>'form-control','placeholder'=>'Api Key','required'=>true)); ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <?php echo $this->Form->input('template_name',array('type'=>'text','label'=>false,'class'=>'form-control','placeholder'=>'Template Name','required'=>true)); ?>
                                            </div>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" >
                                                        ...
                                                        <tbody>
                                                            <?php  $i =1; foreach($data5 as $d): ?>
                                                                <tr >
                                                                    <td><?php echo $i++; $id = $d['Template']['id']; ?></td>                                                               
                                                                    <td><?php echo $d['Template']['alert_type']; ?></td>
                                                                     <td><?php echo $d['Template']['categoryName']; ?></td>
                                                                    <td><?php echo $d['Template']['typeName']; ?></td>
                                                                    <td><?php echo $d['Template']['subtypeName']; ?></td>
                                                                    <td><?php echo $d['Template']['subtype1Name']; ?></td>
                                                                    <td><?php echo $d['Template']['subtype2Name']; ?></td>
                                                                    <td><?php echo $d['Template']['template_id']; ?></td>
                                                                    <td><?php echo $d['Template']['template_name']; ?></td>
                                                                    <td><?php echo $d['Template']['api_key']; ?></td>

                                                                    <td><?php echo $d['Template']['alertOn']; ?></td>
                                                                    <td >
                                                                        <!-- <a  href="#" class="btn-raised" data-toggle="modal" data-target="#esclationUpdate" onclick="view_edit_alert_esclation('<?php //echo $id;?>','tab5')" >
                                                                            <label class="btn btn-xs btn-midnightblue btn-raised"><i class="fa fa-edit"></i><div class="ripple-container"></div></label>
                                                                        </a>  -->
                                                                        <a href="#" onclick="deleteData('<?php echo $this->webroot;?>Escalations/delete_whatsapp_caller?id=<?php echo $id;?>&tab=tab5')" >
                                                                            <label class="btn btn-xs tn-midnightblue btn-raised"><i class="fa fa-trash"></i></label>
                                                                        </a>
                                                                    </td>  
                                                                </tr>
                                ...
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    ...
                                    <div class="panel-body" id="tab4" >                 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-sm-2 control-label">Vendor</label>
                                                <div class="col-sm-2">
                                                    <?php echo $this->Form->input('vendor',array('label'=>false,'class'=>'form-control','options'=>array('Pratesh'=>'Vendor 1','AiSensy'=>'Vendor 2'),'empty'=>'Select','required'=>true)); ?>
                                                </div>
                                                        ...
                                                        <tbody>
                                                            <?php  $i =1; foreach($data4 as $d): ?>
                                                                <tr >
                                                                    ...
                                                                    <td><?php echo $d['SMSText']['subtype2Name']; ?></td>
                                                                   <!-- <td><?php //echo $d['SMSText']['senderID']; ?></td>-->
                                                                   <td><?php echo $d['SMSText']['template_id']; ?></td>
                                                                   <td><?php echo $d['SMSText']['template_name']; ?></td>
                                                                   <td><?php echo $d['SMSText']['api_key']; ?></td>
                                                                    <td><?php echo $d['SMSText']['smsText']; ?></td>
                                                                    <td >
                                                                        <!--
                                    ...
                                    <div class="panel-body" id="tab2"  >                            
                                        <div class="panel panel-default"   data-widget='{"draggable": "false"}'>  
                                            <?php if(isset($tab) && $tab ==="tab2"){?>
                                                <div style="color:green;margin-left:75px;margin-top: 5px;"><?php echo $this->Session->flash(); ?></div>
                                            <?php }?>
                                            <?php echo $this->Form->create('Escalations',array('action'=>'save_alert_esclation','onsubmit'=>'return checkDefineEsclation();','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-sm-2 control-label">Alert On</label>
                                                <div class="col-sm-2">
                                                    <?php echo $this->Form->input('alertOn',array('label'=>false,'id'=>'EscalationsAlertOnTab2','class'=>'form-control','options'=>array('sms'=>'SMS','email'=>'Email','both'=>'both(sms,email)','Whatsapp'=>'Whatsapp'),'empty'=>'Select','required'=>true)); ?>
                                                </div>
                                                <label class="col-sm-2 control-label">Mobile No.</label>
                                                <div class="col-sm-2">
                                                    <?php echo $this->Form->input('mobileNo',array('label'=>false,'id'=>'EscalationsMobileNoTab2','maxlength'=>'10','onkeypress'=>'return checkCharacter(event,this)','class'=>'form-control','placeholder'=>'Mobile No.','required'=>false)); ?>
                                                </div>
                                                <label class="col-sm-2 control-label">Email</label>
                                                <div class="col-sm-2">
                                                    <?php echo $this->Form->input('email',array('label'=>false,'type'=>'text','id'=>'EscalationsEmailTab2','class'=>'form-control','placeholder'=>'Email','required'=>false)); ?>
                                                </div>
                                    ...
                                    <div class="panel-body" id="tab6">                            
                                        <div class="panel panel-default"   data-widget='{"draggable": "false"}'>  
                                            <?php if(isset($tab) && $tab ==="tab6"){?>
                                                <div style="color:green;margin-left:75px;margin-top: 5px;"><?php echo $this->Session->flash(); ?></div>
                                            <?php }?>
                                            <?php echo $this->Form->create('Escalations',array('action'=>'save_agent_alert','onsubmit'=>'return checkDefineEsclation();','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
