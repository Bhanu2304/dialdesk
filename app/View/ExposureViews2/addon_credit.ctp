            ...
            <p class="text-center">Sequence of Records ordered as Active First and Ascending order of Exposure.</p>
                ...
                <table class="table" style="width:100%;font-size: 11px;">
                    ...
                    <tr>
                        ...
                        <th  style="text-align:right;padding:2px;background: #FAEBEB;">Fresh Session</th>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="padding:2px;background: #EEE9E9;" class="left_bord">
                                    ...
                                    <a href="/dialdesk/InitialInvoices/add_bill_tool?cost_center=<?php echo $record['cost_center'];?>&bill_type=subs-tool&amt=<?php echo abs($tobebilled_without_tax);?>&sub_start_date=<?php echo $record['sub_start_date'];?>&sub_end_date=<?php echo $record['sub_end_date'];?>&due_date=<?php echo $record['due_date'];?>">Subscription</a>
                                    <?php }  ?>
