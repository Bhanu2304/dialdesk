...
$data,'empty' => 'Month','required'=>true,'onChange'=>'getDescription(this);get_provision(this.value)')); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        'options'=>array("PlatForm Charges"=>"PlatForm Charges","Talk Time"=>"Talk Time",'Subscription'=>'Subscription','Topup'=>'Top up',"Talk-Time-Tool"=>"Talk Time (Dialdee)",'Subscription-Tool'=>'Subscription (Dialdee)','Topup-Tool'=>'Top up (Dialdee)',"Setup Cost"=>"Setup Cost",'Development Cost'=>'Development Cost','Others'=>'Others'),'required'=>true)); ?>
