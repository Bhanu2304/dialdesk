...
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}' style="margin-top:5px;">
            ...
            <?php $color_array = array('Active'=>"#4CAF50","Hold"=>"#ff9800",'De-Active'=>'#f44336');
                    ...
                    <div class="col-sm-3">
                        <select name="client_status" id="client_status" class="form-control">
                            ...
                            <?php foreach($color_array2 as $st2=>$st3) { ?>
                                <option value="<?php echo $st3; ?>" <?php if($st3==$st2) { echo 'selected';} ?>><?php echo $st2; ?></option>
                            <?php } ?>    
                        </select>
                    </div>
                    <div class="col-sm-2">
                    ...
                    foreach($color_array as $st=>$color)
                    {
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td align="right" style="padding:2px;background: #FAEBEB;"><?php  $csbal = round($record['consume_credit'],2);echo number_format($csbal,2);  $XYZ=$XYZ+$csbal;   ?></td>
