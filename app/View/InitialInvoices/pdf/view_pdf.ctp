...
<table width="544" border ="1" cellpadding="2" cellspacing="0">
	...
	<tr>
		...
		<td  valign="top">
			<table width="130" cellpadding="0" cellspacing="0">
					...
					<tr><td width="130" id = "t07">Bill Date</td></tr>
					<tr><td width="130" id = "t07">Due Date</td></tr>
		...
		<td height="100" valign="top">
			<table cellpadding="0" cellspacing="0" width="130">
					...
					<tr><td width="130"  id = "t07"><?php if(!empty($tbl_invoice['InitialInvoice']['invoiceDate'])) { echo date('Y-m-d',strtotime($tbl_invoice['InitialInvoice']['invoiceDate']));} ?>&nbsp;</td></tr>
					<tr><td width="130"  id = "t07"><?php if(!empty($tbl_invoice['InitialInvoice']['due_date'])) {echo $tbl_invoice['InitialInvoice']['due_date'];} ?>&nbsp;</td></tr>
	...
	<table width="540" height = "200" cellpadding="0" cellspacing="0" >
		...
		<?php
			...
			?>
				...
				<td align="center" valign="top" id = "t02" <?php if(count($inv_particulars)>20) { echo 'style="font-size:8px;"'; } ?>><?php echo "<br>".$post['Particular']['particulars']; if(!empty($tbl_invoice['InitialInvoice']['category']) && strtolower($tbl_invoice['InitialInvoice']['category'])!='others') { if (empty($post['Particular']['sub_category']) ) {echo " ({$tbl_invoice['InitialInvoice']['category']})";} else {echo " ({$post['Particular']['sub_category']})";} }  ?></td>
				<td align="center" valign="top" id = "t02" <?php if(count($inv_particulars)>20) { echo 'style="font-size:8px;"'; } ?>><?php echo "<br>".round($post['Particular']['qty'],2); ?></td>
				<td align="center" valign="top" id = "t02" <?php if(count($inv_particulars)>20) { echo 'style="font-size:8px;"'; } ?>><?php echo "<br>".round($post['Particular']['rate'],2); ?></td>
	...
	<tr>
		...
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['total'],2); ?></th>
	</tr>
	 ...
	 <?php if(strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2017-06-30")) { if($tbl_invoice['InitialInvoice']['cost_GSTType']=='Integrated') {  ?>
		...
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['igst'],2); ?></th>
	</tr>
    <?php } else { ?>    
        <tr>
		<th colspan="2" id ="t04">CGST @ 9%</th>
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['cgst'],2); ?></th>
	</tr>
        <tr>
		<th colspan="2" id ="t04">SGST @ 9%</th>
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['sgst'],2); ?></th>
	</tr>
    <?php }} else { ?>
	<tr>
		<th colspan="2" id ="t04">Service Tax @ 14%</th>
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['tax'],2); ?></th>
	</tr>

	<?php if(strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2015-11-14")) { ?>	
	<tr>
		<th colspan="2" id ="t04">SBC @ 0.5%</th>
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['sbctax'],2); ?></th>
	</tr>
	<?php } ?>
        <?php if(strtotime($tbl_invoice['InitialInvoice']['invoiceDate']) > strtotime("2016-05-31")) { ?>	
	<tr>
		<th colspan="2" id ="t04">KKC @ 0.5%</th>
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['krishi_tax'],2); ?></th>
	</tr>
    <?php }}  ?>
	<tr>
		<th colspan="2" id ="t04">G. Total</th>
		<th id ="t05"><?php echo round($tbl_invoice['InitialInvoice']['grnd'],2); ?></th>
	</tr>
	<tr>
		<td colspan="4" id ="t06"><b><i>Amount In Words : <?php $explode = explode('.',$tbl_invoice['InitialInvoice']['grnd']);
		echo ucwords(convertNumberToWordsForIndia(round($tbl_invoice['InitialInvoice']['grnd'])));
                if(!empty($explode[1])) { echo 'and '.ucwords(convertNumberToWordsForIndia(round($explode[1]))).' Paisa';}
                echo ' Only';?></i></b></td>
		<th id ="t05"></th>
	</tr>
...
<table>
	...
	<tr>
		...
		<td>
			<?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='Mas Callnet India Pvt Ltd')echo $this->Html->image('9001.jpg', array('fullBase' => true,'height'=>74));?>
		</td>
		<td>
			<?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='Mas Callnet India Pvt Ltd')echo $this->Html->image('14001.jpg', array('fullBase' => true,'height'=>74));?>
		</td>
		<td>
			<?php if($tbl_invoice['InitialInvoice']['cost_company_name']=='Mas Callnet India Pvt Ltd')echo $this->Html->image('27001.jpg', array('fullBase' => true,'height'=>80));?>
		</td>
	</tr>
