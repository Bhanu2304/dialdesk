        ...
        <div class="panel panel-default" data-widget='{"draggable": "false"}' style="margin-top:5px;">
            <div class="panel-body" style="margin-top:-10px;padding:0px;">
                ...
                <tr align="center">
                        ...
                        <td><?php echo $this->request->data['InitialInvoice']['cost_center'];
                 $hide['cost_center']=$this->request->data['InitialInvoice']['cost_center']; ?></td>
                        <td><?php echo $this->request->data['InitialInvoice']['finance_year'];
                                $hide['finance_year']=$this->request->data['InitialInvoice']['finance_year'];?>
                        </td>
                        <td><?php echo $this->request->data['InitialInvoice']['month'];
        ...
        <div class="box-content no-padding">
            <table class="table"  style="margin-bottom:0px;">
                <tbody>
                    ...
                    <tr><th>PO No.</th><td> <?php	echo $this->Form->input('InitialInvoice.po_no', array('label'=>false,'required'=>false)); ?></td></tr>
                    <tr><th>Description</th><td><?php	echo $this->Form->input('InitialInvoice.invoiceDescription', array('label'=>false,'required'=>false)); ?></td></tr>
			...
			<?php // echo $this->Form->create('Add',array('url'=>array('controller'=>'AddInvParticulars','action'=>'index'))); ?>
				<table class="table" border="1" style="margin-bottom:0px;">
                                            ...
                                            <tbody>
                                                <tr>
                                                        ...
                                                        <td><?php   echo $this->Form->input('AddInvParticular.qty', array('label'=>false,'placeholder'=>'Qty','onKeypress'=>'return isNumberKey(event)')); ?></td>
                                                        <td><?php   echo $this->Form->input('AddInvParticular.rate', array('label'=>false,'placeholder'=>'Rate','onBlur'=>'getAmount(this.value)','onKeypress'=>'return isNumberKey(event)')); ?></td>
                                                        <td><?php   echo $this->Form->input('AddInvParticular.amount', array('label'=>false,'value'=>0,'placeholder'=>'Amount','readonly'=>true)); ?></td>
                                                        <td><?php echo $this->Js->submit('ADD', array('url' => array('controller' => 'InitialInvoices','action' => 'add_part1'
                                                        ),'update' => '#mm','complete' => 'getBlank()','data'=>'#particulars')); ?></td>
                                                </tr>
                                            </tbody>
				...
				<div id="xx"><input type='hidden' value='0' id='par_total' name='par_total'></div>
						...
						<?php  foreach ($tmp_particulars as $post): ?>
							<?php $idx.=$post['AddInvParticular']['id'].',';$i++; ?>
							<tr>
							<td><?php echo $i;?></td>
                            
                            <td><?php echo $this->Form->input('Particular.'.$post['AddInvParticular']['id'].'.service',array('label'=>false,'options'=>$service_list,'value'=>$post['AddInvParticular']['service_id'])); ?></td>
							...
							<td><?php echo $this->Form->input('Particular.'.$post['AddInvParticular']['id'].'.qty',array('label'=>false,'value'=>$post['AddInvParticular']['qty'],'onkeypress'=>'return isNumberKey(event)')); ?></td>
							<td><?php echo $this->Form->input('Particular.'.$post['AddInvParticular']['id'].'.rate',array('label'=>false,'value'=>$post['AddInvParticular']['rate'],'onBlur'=>'getAmount1(this.id)','onkeypress'=>'return isNumberKey(event)')); ?></td>
							<td><?php echo $this->Form->input('Particular.'.$post['AddInvParticular']['id'].'.amount',array('label'=>false,'value'=>$post['AddInvParticular']['amount'],'readonly'=>true)); ?></td>
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-content no-padding">
                ...
                <tr><td></td><td><button type="submit" class="btn btn-success btn-label-left" onClick="return validate()"><b>Submit</b></button></td></tr>
</table>
