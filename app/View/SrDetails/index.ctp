...
function closing(){
   ...
   function selectCategory(pid,id){
    ...
    $.post("<?php echo $this->webroot?>SrDetails/selectCategory",{parent_id:pcid,divid:k},function(data){
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" id="panel-inline">
                        ...
                        <div style="margin-top:-23px;margin-left:15px;">
                            ...
                            <?php echo $this->Form->create('IbExportReports',array('id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <?php
                                            echo $this->Form->input('startdate',array('label'=>false,'value'=>isset($showVal['startdate'])?$showVal['startdate']:"",'placeholder'=>'Start Date','id'=>'fdate','class'=>'form-control date-picker','autocomplete'=>'off'));
                                            if(!empty($Category1)){
                                    ...
                                    <div class="col-sm-2">
                                        <?php
                                            echo $this->Form->input('enddate',array('label'=>false,'value'=>isset($showVal['enddate'])?$showVal['enddate']:"",'placeholder'=>'End Date','id'=>'ldate','class'=>'form-control date-picker','autocomplete'=>'off'));
                                            // if(!empty($Category2)){
				    ...
				    echo "<th>Case Closed By</th>";
                                    echo "<th>Call Date</th>";
                                    echo "<th>Tat</th>";
                                    echo "<th>Due Date</th>";
                                    echo "<th>Call Created</th>";
                                    echo "<th>Closure Time</th>";
				    ...
				    else
				    {
						foreach($keys as $k){ 
                                    ...
                                    if($showVal['CloseLoopCate1'] == '0' || empty($his['CallMaster']['CloseLoopCate1'])){
                                        echo "<td>Open</td>";
                                    }else{
