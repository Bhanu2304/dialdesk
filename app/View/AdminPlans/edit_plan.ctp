...
<div class="container-fluid">
    <div class="panel panel-default" data-widget='{"draggable": "false"}' style="margin-top:5px;">
            ...
            <div class="panel-body" style="margin-top:-10px;" >
                ...
                <?php echo $this->Form->create('AdminPlans',array('action'=>'client_wise_plan_update')); ?>        
                    <div class="col-md-12">
			 ...
			 <div class="col-md-3">
				     ...
				     <span>Disable</span> <input type="radio" id="first_minute" value="Disable" <?php if($plan['PlanMaster']['first_minute']=='Disable') echo 'checked'; ?>  name="first_minute"><span class="material-input"></span>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <select id="TransferAfterRental" name="TransferAfterRental" onChange="show_flat(this.value);" required="" class="form-control">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" id="MultiIBCharges" name="MultiIBCharges" value="<?php echo $plan['PlanMaster']['MultiIBCharges']; ?>" placeholder="Multi Language (Inbound Charge)"
                    ...
                    <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <select id="pulse_ib_multi" name="pulse_ib_multi"  onchange="get_rate_pulse_ib_multi(this.value)" required="" class="form-control">
                                     <option value="<?php echo $plan['PlanMaster']['pulse_ib_multi']; ?>"><?php echo $plan['PlanMaster']['pulse_ib_multi']; ?></option>
                     ...
                     <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <input type="text" id="rate_per_pulse_ib_multi" readonly name="rate_per_pulse_ib_multi" value="<?php echo $plan['PlanMaster']['rate_per_pulse_ib_multi']; ?>" placeholder="Rate Per Pulse" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                           </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" id="MultiOBCharges" name="MultiOBCharges" value="<?php echo $plan['PlanMaster']['MultiOBCharges']; ?>"
                        ...
                        <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <select id="pulse_ob_multi" name="pulse_ob_multi"  onchange="get_rate_pulse_ob_multi(this.value)" required="" class="form-control">
                                     <option value="<?php echo $plan['PlanMaster']['pulse_ob_multi']; ?>"><?php echo $plan['PlanMaster']['pulse_ob_multi']; ?></option>
                                     <option value="1">1</option>
                                     <option value="15">15</option>
                                     <option value="30">30</option>
                                     <option value="45">45</option>
                     ...
                     <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <input type="text" id="rate_per_pulse_ob_multi" readonly name="rate_per_pulse_ob_multi" value="<?php echo $plan['PlanMaster']['rate_per_pulse_ob_multi']; ?>" placeholder="Rate Per Pulse" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                           </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" id="MultiLiveChat" name="MultiLiveChat" value="<?php echo $plan['PlanMaster']['MultiLiveChat']; ?>"
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input type="text" id="whatsapp_message_charge" name="whatsapp_message_charge" value="<?php echo $plan['PlanMaster']['whatsapp_message_charge']; ?>"
                                    placeholder="Whatsapp SMS Charge" onkeypress="return checkCharacter(event,this)"
                                    required="" class="form-control decimal">
                            </div>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="input-group">
                        ...
                        <input type="submit" value="Update" class="btn-web btn" style="margin-top: 26px;">
                    </div>
                </div>
