...
function get_rate_per_pulse_outbound_call_shift(value)
   {
    ...
    function get_rate_pulse_ib_multi(value)
    {
     //alert('kkk');
        var MultiIBCharges = document.getElementById('MultiIBCharges').value; //alert (MultiIBCharges);

        if(value=='1')
        {
            document.getElementById('rate_per_pulse_ib_multi').value= ( MultiIBCharges / 60 ) * 1;
        }
         else if(value=='15')
        {
            document.getElementById('rate_per_pulse_ib_multi').value= ( MultiIBCharges / 60 ) * 15;      
         }
        else if(value=='30')
        {
            document.getElementById('rate_per_pulse_ib_multi').value= ( MultiIBCharges / 60 ) * 30;        
        }
        else if(value=='45')
        {
            document.getElementById('rate_per_pulse_ib_multi').value= ( MultiIBCharges / 60 ) * 45;        
        }
    
     else if(value=='60')
        {
            document.getElementById('rate_per_pulse_ib_multi').value= ( MultiIBCharges / 60 ) * 60;       
        }
    ...
    function get_rate_pulse_ob_multi(value)
    {
     //alert('kkk');
        var MultiOBCharges = document.getElementById('MultiOBCharges').value; //alert (MultiOBCharges);

        if(value=='1')
        {
            document.getElementById('rate_per_pulse_ob_multi').value= ( MultiOBCharges / 60 ) * 1;
        }
         else if(value=='15')
        {
            document.getElementById('rate_per_pulse_ob_multi').value= ( MultiOBCharges / 60 ) * 15;      
         }
        else if(value=='30')
        {
            document.getElementById('rate_per_pulse_ob_multi').value= ( MultiOBCharges / 60 ) * 30;        
        }
        else if(value=='45')
        {
            document.getElementById('rate_per_pulse_ob_multi').value= ( MultiOBCharges / 60 ) * 45;        
        }
    
     else if(value=='60')
        {
            document.getElementById('rate_per_pulse_ob_multi').value= ( MultiOBCharges / 60 ) * 60;       
        }
    ...
    <div class="panel panel-default" data-widget='{"draggable": "false"}' style="margin-top:5px;">
			...
			<!-- Basant Code Start From here ---->
			         ...
			         <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <input type="text" id="rate_per_pulse_day_shift" readonly name="rate_per_pulse_day_shift" placeholder="Rate Per Pulse" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                           </div>
                        </div>
			...
			<div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <input type="text" id="rate_per_pulse_night_shift"  readonly name="rate_per_pulse_night_shift" placeholder="Rate Per Pulse" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                           </div>
                        </div>
			...
			<div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <input type="text" id="rate_per_pulse_outbound_call_shift"  readonly name="rate_per_pulse_outbound_call_shift" placeholder="Rate Per Pulse" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                           </div>
                        </div>
			...
			<div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <span style="font-style:italic;">IVR Call Charge</span>
                                 <div class="form-group is-empty"><input type="text" id="IVR_Charge" name="IVR_Charge" placeholder="IVR Call Rs./CALL" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal"><span class="material-input"></span></div>
                           </div>
                        </div>
                            ...
                            <div class="input-group">                           
                                ...
                                <span style="font-style:italic;">First Minute</span>
                                 <div class="form-group is-empty">
                                     ...
                                     <span>Enable</span> <input type="radio" id="first_minute" value="Enable" name="first_minute"><span class="material-input"></span> 

				     <span>Disable</span> <input type="radio" id="first_minute" value="Disable" name="first_minute"><span class="material-input"></span>
                        ...
                        <!-- <div class="col-md-3" id="flatDisp" style="display:none">
                            <div class="input-group">                           
                                ...
                                <input type="text" id="Flat" name="Flat" placeholder="% Used to Balance Carry Forward" onkeypress="return checkCharacter(event,this)"  class="form-control decimal">
                           </div>
                        </div>  -->
                ...
                <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <span>Pulse(Multi Language)</span>
                                <select id="pulse_ib_multi" name="pulse_ib_multi"  onchange="get_rate_pulse_ib_multi(this.value)" required="" class="form-control">
                                     <option value="">Select</option>
                                     <option value="1">1</option>
                                     <option value="15">15</option>
                                     <option value="30">30</option>
                     ...
                     <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <span>Rate Per Pulse(Multi Language)</span>
                                <input type="text" id="rate_per_pulse_ib_multi" readonly name="rate_per_pulse_ib_multi" placeholder="Rate Per Pulse" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                           </div>
                        </div>
                ...
                <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <span>Pulse(Multi Language OB)</span>
                                <select id="pulse_ob_multi" name="pulse_ob_multi"  onchange="get_rate_pulse_ob_multi(this.value)" required="" class="form-control">
                                     <option value="">Select</option>
                                     <option value="1">1</option>
                                     <option value="15">15</option>
                                     <option value="30">30</option>
                     ...
                     <div class="col-md-3">
                            <div class="input-group">                           
                                ...
                                <span>Rate Per Pulse(Multi Language OB)</span>
                                <input type="text" id="rate_per_pulse_ob_multi" readonly name="rate_per_pulse_ob_multi" placeholder="Rate Per Pulse" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                           </div>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="input-group">                           
                        ...
                        <span >Whatsapp SMS Charge</span>
                        <input type="text" id="whatsapp_message_charge" name="whatsapp_message_charge" placeholder="Whatsapp SMS Charge" onkeypress="return checkCharacter(event,this)" required="" class="form-control decimal">
                    </div>
                </div>
