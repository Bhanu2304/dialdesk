...
<!--             <table class="display table table-bordered table-condensed table-hovered sortableTable"> -->
            <table class="table table-striped table-bordered datatables"> 
                ...
                <tr>
                    ...
                    <?php if($this->Session->read('admin_id') == '1') { echo '<th>ACTON</th>';} ?>
                    <th>Plan</th>
...
<!--                    <th>Action</th>-->
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $i++; ?></td>
                        <?php if($this->Session->read('admin_id') == 1) { ?>
                ...
                <td style="text-align:left;"><?php echo $plan['PlanMaster']['PeriodType']=='Quater'?'Quarter':$plan['PlanMaster']['PeriodType']; ?></td>
