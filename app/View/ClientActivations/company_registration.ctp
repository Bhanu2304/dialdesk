                ...
                <div class="panel-body"> 
                    <form action="<?php echo $this->webroot;?>ClientActivations/save_company" method="post" accept-charset="utf-8" id="company_register_form" class="registration-form form-horizontal row-border" enctype="multipart/form-data" data-parsley-validate >
                        <fieldset id="fieldset1" >
                            ...
                            <div class="col-md-4">
                               <div class="col-xs-12">
                                ...
                                <div class="col-xs-12">
                                    <div class="input-group">							
                                        ...
                                        <?php echo $this->Form->input('reg_office_address1',array('label'=>false,'maxlength'=>'255','value'=>isset ($data['TmpRegistrationMaster']['reg_office_address1']) ? $data['TmpRegistrationMaster']['reg_office_address1'] : "",'id'=>'office_address1','autocomplete'=>'off','class'=>'form-control','placeholder'=>'Registered Office Address 1'));?>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="input-group"> 								
                                        ...
                                        <?php echo $this->Form->input('reg_office_address2',array('label'=>false,'maxlength'=>'250','value'=>isset ($data['TmpRegistrationMaster']['reg_office_address2']) ? $data['TmpRegistrationMaster']['reg_office_address2'] : "",'id'=>'office_address2','autocomplete'=>'off','class'=>'form-control','placeholder'=>'Registered Office Address 2')); ?>
                                    </div>
                                </div>
                               ...
                               <div class="col-xs-12">
                                    <div class="input-group">							
                                        ...
                                        <?php echo $this->Form->input('gst_no',array('label'=>false,'pattern'=>'.{0}|.{15,15}','title'=>'15 chars Required','value'=>'','id'=>'gst_no','placeholder'=>'GST No.','autocomplete'=>'off','class'=>'form-control'));?>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4"> 
                                <div class="col-xs-12" style="padding-top: 17px;">
                                    <label class="col-sm-6 control-label">Same As Registered Office</label>	
                                    <div class="col-sm-6">
                                ...
                                <div class="input-group">							
                                    <span class="input-group-addon">
                                     ...
                                     <div style="margin-top: 35px;margin-left:-233%;" >Note -  All fields are mandatory.</div>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">							
                                    <span class="input-group-addon">
                                     ...
                                     <div style="margin-top: 35px;margin-left:-233%;" >Note - Details of at least one person is mandatory.</div>
                                </div>
                        ...
                        <fieldset id="fieldset3">
                            ...
                            <div class="col-md-12">
                                <div class="col-xs-12">    
                                    <h5 style="margin-left:115px;position: relative;top:30px;" >Note - Please use only jpg,gif,png,pdf for upload.</h5>              
                                </div>  
                            </div>
                        ...
                        <div class="otp">
                          ...
                          -->
                          <h4 style="margin-top:30px;">Authentication <i class="fa fa-user detail" aria-hidden="true"></i></h4>  
                          <hr/>
                          <p>OTP has sent to registered mobile number</p>
                          ...
                          <div id="otp_box" style="display:none" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">                                
                                    <input type="text" class="form-control" id="otp_data" style="width:200px;" autocomplete="off" placeholder="Enter OTP" />
                                </div>
                            </div>
