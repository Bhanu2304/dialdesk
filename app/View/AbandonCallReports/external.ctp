...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>AbandonCallReports/export_abandon_export_reports');
        }
...
<ol class="breadcrumb">                                
    ...
    <li><a href="#">Abandon Call Detail Analysis Reports</a></li>
    <li class="active"><a href="#">Abandon Call Detail Analysis Reports</a></li>
</ol>
<div class="page-heading">            
    <h1>Abandon Call Detail Analysis Reports </h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Abandon Call Detail Analysis Reports </h2>
            </div>
