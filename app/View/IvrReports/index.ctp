...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>IvrReports/export_ivr_log');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>IvrReports');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">IVR Report</a></li>
</ol>
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            ...
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('IvrReports',array('action'=>'index','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
