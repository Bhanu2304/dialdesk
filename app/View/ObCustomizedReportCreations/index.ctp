...
<div class="page-heading">            
    <h1>Manage Out Call Customized MIS</h1>
</div>
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Manage Out Call Customized MIS</h2>
                <div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div>
            </div>
            <div data-widget-controls="" class="panel-editbox"></div>
            <div class="panel-body">
                <?php echo $this->Form->create('ObCustomizedReportCreations',array('action'=>'index','id'=>'showsheet')); ?>
                ...
                <div class="form-group">
                    <div class="col-sm-4">
                        <select  name="campaign" class="form-control"  required="" onchange="getsheet(this.value);">
                            <option value="">Select Campaign</option>
                            <?php foreach($Campaign as $campkey=>$camp){?>
                            <option value="<?php echo $campkey;  ?>" <?php if($campaign_id == $campkey){echo "selected='selected'";} ?>><?php echo $camp;  ?></option>
                            <?php }?>
                        </select>
                    </div>
                    
                    <div class="col-sm-4" id="sheet_disp">
...
<script>
    function getsheet(campaign){
        $.ajax({
            type: "POST",
            url:'ObCustomizedReportCreations/get_sheet_name',
            data: {campaign:campaign},
            success: function(data){
                    if(data !=''){
                        $("#sheet_disp").html(data);
