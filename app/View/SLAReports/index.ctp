...
function viewReport1(){
    ...
    if(client_id ==""){
       ...
       return false; 
        ...
        $.post('<?php echo $this->webroot?>SLAReports/view_report',{fdate:fdate,ldate:ldate,client_id:client_id},function(data){
           $("#showCallReport").show();
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Call Tagging Report</a></li>
</ol>
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            ...
            <div class="panel-body">
                <form method="post" action="<?php echo $this->webroot;?>SLAReports"  class="form-horizontal row-border" >
                    <div class="form-group">
                        <div class="col-sm-3">
                            <select id="client_id" name="client_id" class="form-control">
                                ...
                                <option value="<?php echo $client_det['RegistrationMaster']['company_id']; ?>"><?php echo $client_det['RegistrationMaster']['company_name']; ?></option>
                                <?php } ?>
                            </select> 
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3" style="margin-top:-12px;">
                            <input type="button"  class="btn btn-web" value="View" onclick="viewReport1();" >
