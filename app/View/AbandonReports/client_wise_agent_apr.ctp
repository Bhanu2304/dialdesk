...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            ...
            var campaign =$("#client").val();
            var query_date =  $("#fdate").val();
            var end_date  =   $("#ldate").val();

            var url = 'DB=&query_date='+query_date+'&end_date='+end_date+'&group[]='+campaign+'&user_group%5B%5D=--ALL--&shift=ALL&report_display_type=TEXT&SUBMIT=SUBMIT';
       
            window.open("<?php echo $this->webroot.'app/webroot/billing_statement/apr_report/AST_agent_time_detail.php?'; ?>"+url,'_blank');
            //$('#validate-form').attr('action','<?php echo $this->webroot;?>AbandonReports/client_wise_agent_apr');
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Client Wise Agents APR</a></li>
</ol>
<div class="page-heading">            
    <h1>Client Wise Agents APR</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Client Wise Agents APR </h2>
            </div>
            <div class="panel-body">
                <div id="error" style="color:red;font-size: 15px;"><?php echo $this->Session->flash();?></div>
                <?php echo $this->Form->create('AbandonReports',array('action'=>'client_wise_agent_apr','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
