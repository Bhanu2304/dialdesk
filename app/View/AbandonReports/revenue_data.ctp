...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>AbandonReports/revenue_data_excel');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>AbandonReports/revenue_data');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Analysis Report</a></li>
</ol>
...
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            ...
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('AbandonReports',array('action'=>'revenue_data','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
    ...
    foreach ($datearray as $date) {
        echo "<td style=\"text-align:center;\">" . date('d', strtotime($date)) . "</td>";
    }
    ?>
</tr>
</thead>
    ...
    <tr style="background-color:#317EAC; color:#FFFFFF;">
        ...
        foreach ($datearray as $date) {
            foreach ($label_arr as $label => $key) {
                ...
                echo "<td>" . round($columnTotals[$date][$key], 2) . "</td>";
            }
        }
        ?>
    </tr>
