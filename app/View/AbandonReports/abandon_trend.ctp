...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>AbandonReports/abandon_trend_excel');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>AbandonReports/abandon_trend');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Call Abandon Trend</a></li>
</ol>
<div class="page-heading">            
    <h1>Call Abandon Trend</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Call Abandon Trend</h2>
            </div>
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('AbandonReports',array('action'=>'index','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <?php echo $this->Form->input('category',array('label'=>false,'id'=>'category','required'=>'true','class'=>'form-control','options'=>array("All"=>"All","A"=>"A","B"=>"B"),'empty'=>'Select Type','required'=>true)); ?>
                        ...
                        <div class="col-sm-2">
                            <?php echo $this->Form->input('Noofcount',array('label'=>false,'placeholder'=>'No Of Count','id'=>'Noofcount','class'=>'form-control','autocomplete'=>'off'));?>
                        </div>
    ...
    <tr style="background-color:#317EAC; color:#FFFFFF;">         
     ...
     <th>Date</th>
    <?php foreach($datearray as $date) { echo "<td style=\"text-align:center;\">".date('d', strtotime($date));"</td>"; 
    } ?>
