...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>AbandonReports/agent_wise');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Agents wise Utilization</a></li>
</ol>
<div class="page-heading">            
    <h1>Agents wise Utilization</h1>
</div>
