    ...
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">
                ...
                <?php  
                    echo $this->Form->create('AdminobclientFields',array('action'=>'index','id'=>'cptfields'));
                ...
                <?php echo $this->Form->create('AdminobclientFields',array('action'=>'add',"class"=>"form-horizontal row-border")); ?>
                    <table class="display table table-bordered table-condensed table-hovered sortableTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="data[AdminobclientFields][FieldValidation]" id="AdminobclientFieldsFieldValidation" value="Numeric"> Numeric <br/>
                                <input type="radio" name="data[AdminobclientFields][FieldValidation]" id="AdminobclientFieldsFieldValidation" value="Char"> Char <br/>
                            </td>
                        </tr>
...
<div class="row-fluid">
    <div class="span12">
        <div class="box dark">
            ...
            <div id="div-1" class="accordion-body collapse in body">
                 <?php echo $this->Form->create('AdminobclientFields',array('action'=>'setPriority','class'=>'form-horizontal row-border')); ?>
