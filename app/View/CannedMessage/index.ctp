...
<script>
    ...
    function allowonlynumber(e,t){
        ...
        function add_raw()
        {
            ...
            if(return_flag)
            {
                $.post('<?php echo $this->webroot.'CannedMessage/save_raw';?>',
                {
                    client_id:client_id,
                    percent:percent,
                    email:email,
        ...
        {
            $.post('<?php echo $this->webroot.'CannedMessage/del_raw';?>',
            {
                risk_id:row_id
            },
            function(data){
        ...
        {
            $.post('<?php echo $this->webroot.'CannedMessage/get_raw';?>',
            {
                client_id:client_id
            },
            function(data){
...
<ol class="breadcrumb">                                
    ...
    <li><a href="#">Canned Message</a></li>
    <li class="active"><a href="#">Canned Message</a></li>
</ol>
<div class="container-fluid">
        <div data-widget-group="group1">
            <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                <div class="panel-heading">
                    <h2>Canned Message</h2>
                    ...
                    <div class="form-horizontal row-border">
                        <table class="table" id="tbl">
                            ...
                            <tr id="tr0">
                                ...
                                <td>
                                    <textarea type="text" id="remarks1" name="remarks1" value="" placeholder="Message"  ></textarea>
                                </td>
                                <td>
