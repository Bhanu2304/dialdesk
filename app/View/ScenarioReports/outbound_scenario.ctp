...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>ScenarioReports/export_outbound_scenario');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>ScenarioReports/outbound_scenario');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Outbound Scenario</a></li>
</ol>
<div class="page-heading">            
    <h1>Outbound Scenario</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Outbound Scenario Reports</h2>
            </div>
            <div class="panel-body">
                <div id="error" style="color:red;font-size: 15px;"><?php echo $this->Session->flash();?></div>
                <?php echo $this->Form->create('ScenarioReports',array('action'=>'index','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
        ...
        <?php if(isset($data_arr) && $data_arr !=""){?>
        <div class="panel panel-default" id="panel-inline">
            <div class="panel-heading">
                <h2>Outbound Scenario</h2>
