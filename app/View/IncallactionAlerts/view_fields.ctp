...
function getCallActionSubType(id,type){
    $.post('<?php echo $this->webroot;?>IncallactionAlerts/call_action_subtype',{'id':id},function(result){
        if(result){
            $("#"+type+"_call_action_sub_type").html(result);
        }
    });
}
...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo $this->webroot;?>Ecrs">Manage In Call Action Alerts</a></li>                    
</ol> 
<div class="page-heading">                                           
    <h1>Manage In Call Action Alerts</h1>
</div>
                    ...
                    <div class="panel-body">
                                ...
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    ...
                                    <div class="panel-body" id="tab1"   >                                      
                                        <div class="panel panel-default"   data-widget='{"draggable": "false"}'>   
                                            ...
                                            <?php }?>
                                            <?php echo $this->Form->create('IncallactionAlerts',array('action'=>'save_incall_action_matrix','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
                                                ...
                                                <div class="form-group"> 
                                                    ...
                                                    <div class="col-sm-3">
                                                         <?php echo $this->Form->input('call_action_type',array('label'=>false,'class'=>'form-control','options'=>$ParentList,'empty'=>'Call Action Type','onchange'=>"getCallActionSubType(this.value,'t1a')",'required'=>true)); ?>
                                                    </div>
                                                    
                                                    <label class="col-sm-2 control-label">Call Action Sub Type</label>
                                                    <div class="col-sm-3">
                                                         <?php echo $this->Form->input('call_action_sub_type',array('label'=>false,'class'=>'form-control','options'=>'','id'=>'t1a_call_action_sub_type','empty'=>'Call Action Sub Type')); ?>                                                     
                                                    </div> 
                                                </div>
                                        ...
                                        <div class="panel panel-default " style="margin-top: 20px;" id="panel-inline">
                                                ...
                                                <div class="panel-body1 no-padding scrolling">
                                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" >
                                                        ...
                                                        <tbody>
                                                             <?php  $i =1; foreach($data1 as $d): $id = $d['InCallActionMatrix']['id']; ?>
                                                                <tr >
                                                                    <td><?php echo $i++; ?></td>
                                                                    <td><?php echo $d['InCallActionMatrix']['personName']; ?></td>
                                                                    <td><?php echo $d['InCallActionMatrix']['alertType']; ?></td>
                                                                    <td><?php echo $d['InCallActionMatrix']['call_action_type_name']; ?></td>
                                                                    <td><?php echo $d['InCallActionMatrix']['call_action_sub_type_name']; ?></td>
                                                                    <td><?php echo $d['InCallActionMatrix']['mobileNo']; ?></td>
                                                                    <td><?php echo $d['InCallActionMatrix']['email']; ?></td>
                                                                    <td><?php echo $d['InCallActionMatrix']['alertOn']; ?></td>
                                                                    <td>
                                                                        ...
                                                                        <a href="#" onclick="deleteData('<?php echo $this->webroot;?>IncallactionAlerts/delete_matrix?id=<?php echo $id;?>&tab=tab1')" >
                        ...
                        <script>
                            function view_edit_alert_esclation(id,type){
                                $.post("<?php echo $this->webroot;?>IncallactionAlerts/view_edit_data",{id:id,type:type},function(data){
                                    $("#ae-data").html(data);
                                }); 
                            }
                        </script>
                                ...
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    ...
                                    <div class="panel-body" id="tab3"  >                 
                                        ...
                                        <?php if(isset($tab) && $tab ==="tab3"){?>
                                                <div style="color:green;margin-left:75px;margin-top: 5px;"><?php echo $this->Session->flash(); ?></div>
                                            <?php }?>
                                            <?php echo $this->Form->create('IncallactionAlerts',array('action'=>'save_customer_smstext','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                                                                       
                                            <?php echo $this->Form->hidden('tabType',array('label'=>false,'class'=>'form-control','value'=>'tab3')); ?>
                                           
                                        <div class="form-group"> 
                                            <label class="col-sm-2 control-label">Call Action Type</label>
                                            <div class="col-sm-2">
                                                 <?php echo $this->Form->input('call_action_type',array('label'=>false,'class'=>'form-control','options'=>$ParentList,'empty'=>'Call Action Type','onchange'=>"getCallActionSubType(this.value,'t3a')",'required'=>true)); ?>
                                            </div>

                                            <label class="col-sm-2 control-label">Call Action Sub Type</label>
                                            <div class="col-sm-2">
                                                 <?php echo $this->Form->input('call_action_sub_type',array('label'=>false,'class'=>'form-control','options'=>'','id'=>'t3a_call_action_sub_type','empty'=>'Call Action Sub Type')); ?>                                                     
                                            </div> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-2 control-label">Alert Text</label>
                                            <div class="col-sm-6">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" >
                                                        ...
                                                        <tbody>
                                                            <?php  $i =1; foreach($data3 as $d): ?>
                                                                <tr >
                                                                    <td><?php echo $i++; $id = $d['InCallActionSms']['id']; ?></td>                                                               
                                                                    <td><?php echo $d['InCallActionSms']['alertType']; ?></td>
                                                                    <td><?php echo $d['InCallActionSms']['call_action_type_name']; ?></td>
                                                                    <td><?php echo $d['InCallActionSms']['call_action_sub_type_name']; ?></td>
                                                                    <td><?php echo $d['InCallActionSms']['senderID']; ?></td>
                                                                    <td><?php echo $d['InCallActionSms']['smsText']; ?></td>
                                                                    <td >
                                                                        <a  href="#" class="btn-raised" data-toggle="modal" data-target="#esclationUpdate" onclick="view_edit_alert_esclation('<?php echo $id;?>','tab3')" >
                                                                            <label class="btn btn-xs btn-midnightblue btn-raised"><i class="fa fa-edit"></i><div class="ripple-container"></div></label>
                                                                        </a> 
                                                                        <a href="#" onclick="deleteData('<?php echo $this->webroot;?>IncallactionAlerts/delete_sms?id=<?php echo $id;?>&tab=tab3')" >
                                                                            <label class="btn btn-xs tn-midnightblue btn-raised"><i class="fa fa-trash"></i></label>
                                                                        </a>
                                                                    </td>  
                                                                </tr>
...
<div class="modal fade" id="esclationUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="top:100px;width:750px;" >
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Edit In Call Action Alerts</h4>
            </div>
             <div id="ae-data" ></div> 
        </div>
    </div>
