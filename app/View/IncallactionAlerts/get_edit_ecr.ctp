...
if(is_array($data) && !empty($data))
{
    ...
    echo $this->Form->input('Escalations.'.$newType,array('label'=>false,'options'=>$data,'value'=>isset($slt)?$slt:"",'empty'=>'Select','class'=>'form-control','onchange'=>$function."(this.value,'".$this->webroot."escalations/get_edit_ecr','".$divtype."','')"));
    echo '</div>';
}
