...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>CustomizedMisReports/export_customize_summary');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Customized Summary Report</a></li>
</ol>
<div class="page-heading">            
    <h1>Customized Summary Report</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Customized Summary Report</h2>
            </div>
            <div class="panel-body">
                <div id="error" style="color:red;font-size: 15px;"><?php echo $this->Session->flash();?></div>
                <?php echo $this->Form->create('CustomizedMisReports',array('action'=>'customize_report','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
