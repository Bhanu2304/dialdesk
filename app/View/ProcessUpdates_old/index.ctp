                ...
                <div class="col-md-6">
                    ...
                    <div class="col-xs-12">
                        <div class="input-group" style="padding-bottom: 15px;">
                            ...
                            <?php echo $this->Form->input('processdate',array('label'=>false,'type'=>'datetime-local','class'=>'form-control','id'=>'processdate'));?>
                    ...
                    <div class="col-xs-12">
                        <div class="input-group">
                            <span class="input-group-addon">
                             ...
                             <input type="button" onclick="return submitForm(this.form,'<?php echo $this->webroot;?>ProcessUpdates')"  value="Submit" class="btn-web btn" style="margin-top: 410px;">
                       </div>
                    </div>
