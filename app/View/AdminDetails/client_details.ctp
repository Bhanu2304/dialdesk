...
function updateClient(){
	...
	else if($.trim($("#client_category").val()) ===""){show_error('client_category',req);return false;}
	else if($('input[name="data[permission]"]:checked').val() !="A")
	{
		if($.trim($("#deactive_date").val()) ===""){show_error('deactive_date',req);return false;}
		// show_error('client_category',req);return false;
	}
	// else if($.trim($("#deactive_date").val()) ===""){show_error('deactive_date',req);return false;}
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <table class="table table-striped table-bordered">
                            <tr>
                                <td>
                                    <input type="radio" name="data[permission]"   <?php if(isset($data['RegistrationMaster']['status']) && $data['RegistrationMaster']['status'] =="A" ){echo "checked='checked'";} ?> value="A" onchange="getDeactive(this.value)"> Active <br/>
									<input type="radio" name="data[permission]"   <?php if(isset($data['RegistrationMaster']['status']) && $data['RegistrationMaster']['status'] =="H" ){echo "checked='checked'";} ?> value="H"  onchange="getDeactive(this.value)"> Hold	<br/>							
                                    <input type="radio" name="data[permission]"   <?php if(isset($data['RegistrationMaster']['status']) && $data['RegistrationMaster']['status'] =="D" ){echo "checked='checked'";} ?> value="D"  onchange="getDeactive(this.value)"> Deactive <br/>
									<input type="radio" name="data[permission]"   <?php if(isset($data['RegistrationMaster']['status']) && $data['RegistrationMaster']['status'] =="CL" ){echo "checked='checked'";} ?> value="CL"  onchange="getDeactive(this.value)"> Close
                                </td>
                                <td>
                            ...
                            <tr>
								...
								<td id='deactive_date_input'>
									<?php if(isset($data['RegistrationMaster']['deactive_date']) && strtotime($data['RegistrationMaster']['deactive_date']) != 0){?>

                                    <span style="color: #616161;">Deactivation Date<font>*</font></span>
									<input id="deactive_date" type="text" placeholder="Deactivation Date" name="data[deactive_date]" class="form-control date-picker1"   value="<?php echo date("d-m-Y", strtotime($data['RegistrationMaster']['deactive_date']));?>" >
...
<?php $Benchmark=array("SKILL Against Forecast","Benchmark Vs Actual","Inbound Calls","AL - 95%","SL - 10 sec - 90%","SL - 20 sec - 80%","RL - 98%","CB - within 15 mins","CBSL - 90% CBs to abandoned in 15 mins threshold","Primary LOB","AHT","FTR - 75%","Quality Score - INBOUND","Primary LOB performance","Quality Score - OUTBOUND","Ticket Closure TAT","Login Time","Ready to Take Call time","No of  calls","ACHT","TAlk Time","Utilization","Primary LOV") ; ?>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" >
                <?php foreach($Benchmark as $k=>$v) { ?>    
				    <tr>
                		<td>
                      		<span style="color: #616161;"><?php echo $v;?></span>
							 
      						<?php echo $this->Form->input('Name'.$k,array('label'=>false,'class'=>'form-control','maxlength'=>'255','readonly'=>'true','value'=>$v));?> 
                     	</td>
                     	<td>
                     		<span style="color: #616161;">Green</span> 
							 <?php echo $this->Form->input('Green'.$k,array('label'=>false,'class'=>'form-control','maxlength'=>'255','readonly'=>'','value'=>''));?> 
                    	</td>   
                     	<td>
                     		<span style="color: #616161;">Orange</span>    
							 <?php echo $this->Form->input('Orange'.$k,array('label'=>false,'class'=>'form-control','maxlength'=>'255','readonly'=>'','value'=>''));?> 
                    	</td> 
               			<td>
                     		<span style="color: #616161;">Red</span>  
							 <?php echo $this->Form->input('Red'.$k,array('label'=>false,'class'=>'form-control','maxlength'=>'255','readonly'=>'','value'=>''));?> 
                    	</td>
                 	</tr>
                    <?php } ?>
