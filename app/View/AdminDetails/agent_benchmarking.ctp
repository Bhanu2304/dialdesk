...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Agent Benchmarking</a></li>
</ol>
<div class="page-heading">            
    <h1>Agent Benchmarking</h1>
</div>
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            ...
            <div class="panel-body">
				<?php echo $this->Form->create('Home',array('url'=>'agent_benchmarking','id'=>'view_client_form')); ?>
					<div class="col-sm-3">
						<?php echo $this->Form->input('clientID',array('label'=>false,'class'=>'form-control', 'onchange'=>'viewClient();','options'=>$client,'value'=>isset($companyid)?$companyid:"",'empty'=>'Select Agent','required'=>true)); ?>
					</div>
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo $this->webroot;?>AdminDetails/update_agent_benchmarking" method="post"  accept-charset="utf-8" id="client_form" enctype="multipart/form-data">
				<?php #print_r($benchmark_cat); ?>
