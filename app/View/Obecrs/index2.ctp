            ...
            <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    ...
                                    <div data-widget-controls="" class="panel-editbox"></div>
                                    <div class="panel-body" id="addtype5" style="display:none;">
                                        <?php echo $this->Form->create('ScenarioReports',array('action'=>'export_outbound_scenario',"class"=>"form-horizontal row-border","id"=>"validate-form",'data-parsley-validate')); ?>
                                             <div class="form-group">
                                                <label class="col-sm-4 control-label">Select Campaign</label>
                                                <div class="col-sm-4">
                                                    <?php echo $this->Form->input('campaign',array('label'=>false,'options'=>$Campaign,'empty'=>'Select Campaign Name','class'=>'form-control','required'=>true ));?>
             ...
             <div class="col-md-5">
                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                    ...
                    <div class="panel-body">
                        <?php echo $this->Form->create('Obecr',array('action'=>'index2','id'=>'view_obecr',"class"=>"form-horizontal row-border",'data-parsley-validate')); ?>
