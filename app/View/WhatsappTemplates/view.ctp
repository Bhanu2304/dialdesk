...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>WhatsappTemplates/export_whatsapp_template');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>WhatsappTemplates/view');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Message Broadcasting Report</a></li>
</ol>
<div class="page-heading">            
    <h1>Message Broadcasting Report</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Message Broadcasting Report</h2>
            </div>
            <div class="panel-body">
                <div id="error" style="color:red;font-size: 15px;"><?php echo $this->Session->flash();?></div>
                <?php echo $this->Form->create('WhatsappTemplate',array('action'=>'view','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
        ...
        <div class="panel panel-default" id="panel-inline">
            <div class="panel-heading">
                <h2>VIEW Message Broadcasting Report</h2>
