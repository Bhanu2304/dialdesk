...
function viewReport(type){
    ...
    if(fdate ==""){
       ...
       return false;
        ...
        $.post('<?php echo $this->webroot?>Reports/view_report',{fdate:fdate,ldate:ldate,client_id:client_id},function(data){
           $("#showCallReport").show();
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Call Tagging Report</h2>
                <div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div>
            </div>
            <div data-widget-controls="" class="panel-editbox"></div>
            <div class="panel-body">
                <form method="post" action="<?php echo $this->webroot;?>Reports"  class="form-horizontal row-border" >
                    <div class="form-group">
                       <div class="col-sm-2">
                            <?php echo $this->Form->input('clientID',array('label'=>false,'class'=>'form-control','id'=>'client_id','options'=>$client,'value'=>isset($companyid)?$companyid:"",'empty'=>'Select Client')); ?>
                        </div>
                        <div class="col-sm-2">
