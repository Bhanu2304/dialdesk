...
function viewReport(type){
    ...
    if(fdate ==""){
       ...
       return false;
        ...
        $.post('<?php echo $this->webroot?>billing_statement/basant_combined_all_report.php?FromDate=2022-08-01&ToDate=2022-08-06',{fdate:fdate,ldate:ldate},function(data){
           $("#showCallReport").show();
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Combined Report For All Client</a></li>
</ol>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Combined Report For All Client</h2>
                <div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div>
            </div>
            <div data-widget-controls="" class="panel-editbox"></div>
            <div class="panel-body">
                <form method="get" action="https://dialdesk.co.in/dialdesk/app/webroot/billing_statement/basant_combined_all_report.php"  class="form-horizontal row-border" >
