...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/time_wise_mis');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/export_time_wise_mis');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Time Wise MIS</a></li>
</ol>
