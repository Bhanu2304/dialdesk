...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/call_mis_reports');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/export_call_mis');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Call MIS</a></li>
</ol>
