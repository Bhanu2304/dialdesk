...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/abend_call');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/export_abend_call');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Abend Call MIS</a></li>
</ol>
<div class="page-heading">            
    <h1>Abend Call MIS</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Abend Call MIS Reports</h2>
            </div>
