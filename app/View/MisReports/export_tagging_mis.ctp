...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/tagging_mis');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisReports/export_tagging_mis');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Tagging MIS</a></li>
</ol>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" >
                    ...
                    <?php 
                        ...
                        foreach($scenario as  $scen)
                        {
                            ...
                            $countSub = count($sub_scenario[$scen]);
                            if($countSub==0)
                            {
                            ...
                            echo '<tr>';
                                ...
                                {
                                    $flag = false;
                                    foreach($sub_scenario[$scen] as $sub)
                                    {           
                                        if($flag)
                                        {
                                            echo '</tr><tr>';
                                        ...
                                        echo '<th>'.$sub.'</th>';
                                        echo '<th>'.$sub_scenario_data[$scen][$sub].'</th>';
                                        foreach($DataArr as $k1)
                                        {
