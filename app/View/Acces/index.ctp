...
<ol class="breadcrumb">                                
    ...
    <li><a href="#">Admin Rights</a></li>
    <li class="active"><a href="#">Manage Admin Access</a></li>
</ol>
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            ...
            <div class="panel-body">
                ...
                <div class="col-xs-4">
                        <br/>
                <a href="homes2" class="btn-web btn">Back</a>
                </div>    
                </div>
        <!-- new content -->
...
function auto_fill_all()
{
    ...
    else
    {
        ...
        $.getJSON("<?php echo 'https://'.$_SERVER['SERVER_NAME'].Router::url('/Acces/index'); ?>", {user: $('#selected_user').val()}, function (data) {
...
function show_child(id)
{
    ...
    $('#selected_user').change(function () {
        ...
        $.getJSON("<?php echo 'https://'.$_SERVER['SERVER_NAME'].Router::url('/Acces/get_access_id'); ?>", {user: $('#selected_user').val()}, function (data) {
    ...
    function check() {
        ...
        $.get("<?php echo 'https://'.$_SERVER['SERVER_NAME'].Router::url('/Acces/save'); ?>", {rides: ride,user: $('#selected_user').val()}, function (data) {
            console.log(data);
            if (data = "save") {
                $("#main_container input:checkbox").prop("checked", false);
                $("#status").css({"visibility": "visible"});
