...
<script>
    function plan_validation() {
        ...
        //     return dialdesk_validation();

        // } else if ($('#dialdeecheck').is(":checked")) {

        //     return dialdee_validation();

        // } else if ($('#vfocheck').is(":checked")) {

        //     return vfo_validation();

        // } else if ($('#leadsquarecheck').is(":checked")) {

        //     return leadsquare_validation();

        // } else if ($('input[type=checkbox]').empty) {
...
<div class="panel panel-default" data-widget='{"draggable": "false"}' style="margin-top:5px;">
    ...
    <?php echo $this->Form->create('AdminPlans',array('action'=>'client_wise_plan_creation','onsubmit'=>'return plan_validation();')); ?>
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <input type="text" name="PlanName" placeholder="Plan Name" id="plan_name"
                            class="form-control extclass" required>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <span>Plan Mode</span>
                        <select id="PeriodType" name="PeriodType" onchange="getPeriod(this.value)" class="form-control"
                            required>
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <select id="TransferAfterRental" name="TransferAfterRental" class="form-control" required>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <select id="pulse_day_shift" name="pulse_day_shift"
                                        onchange="get_rate_per_pulse_day_shift(this.value)" class="form-control"
                                        disabled>
                                        <option value="">Select</option>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="rate_per_pulse_day_shift" readonly
                                        name="rate_per_pulse_day_shift" placeholder="Rate Per Pulse"
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <select id="pulse_night_shift" name="pulse_night_shift"
                                        onchange="get_rate_per_pulse_night_shift(this.value)" class="form-control"
                                        disabled>
                                        <option value="">Select</option>
                                        <option value="1">1</option>
                                        <option value="15">15</option>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="rate_per_pulse_night_shift" readonly
                                        name="rate_per_pulse_night_shift" placeholder="Rate Per Pulse"
                                        onkeypress="return checkCharacter(event,this)" class="form-control decimal"
                                        disabled>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <select id="pulse_outbound_call_shift" name="pulse_outbound_call_shift"
                                        onchange="get_rate_per_pulse_outbound_call_shift(this.value)"
