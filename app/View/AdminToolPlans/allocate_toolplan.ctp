...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Allocate ToolPlan</a></li>
</ol>
...
<div class="container-fluid">
    <div data-widget-group="group1">
        ...
        <div class="panel-heading">
            <h2>Allocate ToolPlan</h2>
            <div class="panel-ctrls"></div>
        </div>
        <div class="panel-body">
            <?php echo $this->Session->flash(); ?>
            <?php echo $this->Form->create('AdminToolPlan',array('class'=>'form-horizontal')); ?>    
            <div class="form-group">
                <label class="col-sm-1 control-label">ToolPlan</label>
                <div class="col-sm-3">
