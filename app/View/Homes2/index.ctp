<?php function get_subs_value($PeriodType,$RentalAmount)
{
    switch ($PeriodType) {
        case "YEAR":
            return $RentalAmount; 
            ...
            <div class="page-heading">
                              ...
                              <div class="row">
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-indigo">
                                       <div class="info">
                                          <div class="tile-heading"><span style="text-transform:capitalize">Total Answered Calls</span></div>
                                 ...
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-danger">
                                       <div class="info">
                                          <div class="tile-heading"><span style="text-transform:capitalize">Total Abandon Calls</span></div>
                                 ...
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-primary">
                                       <div class="info">
                                          <div class="tile-heading"><span style="text-transform:capitalize">Total Tagged Calls</span></div>
                                 ...
                                 <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-green">
                                       <div class="info">
                                          <div class="tile-heading"><span style="text-transform:capitalize">Total Abandon Call Back</span></div>
                           ...
                           <div data-widget-group="group1">
                              <div class="row">
                                 <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-indigo">
                                       <div class="info">
                                          <div class="tile-heading"><span>Total Connected Calls</span></div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                    <div class="info-tile info-tile-alt tile-danger">
                                       <div class="info">
                                          <div class="tile-heading"><span>Total Not Connected Calls</span></div>
                  ...
                  {?> 
                     <div class="container">
                        <div class="row">
                           <div class="col-xs-12">
                               <center> <h3>ACTIVE SERVICES</h3></center>
                           </div>
                        </div>
                        <div class="row">
                                      ...
                                      <table class="fl-table">
                                         <thead>
                                              ...
                                              <th>Email Charges</th>
                                                ...
                                                <tbody>
                                              <tr>
                                                  <td class="text-left"><?php echo ucwords(strtolower($pma['plan_master']['PlanName']));?></td>
                                                  <td  class="text-left"><?php  if(strtolower($pma['plan_master']['PeriodType'])=='quater') {echo 'Quarterly';}
                                                                              else if(strtolower($pma['plan_master']['PeriodType'])=='half') {echo 'Half Yearly';}
                                                                              else if(strtolower($pma['plan_master']['PeriodType'])=='year') {echo 'Yearly';}
                                                                              else if(strtolower($pma['plan_master']['PeriodType'])=='month') {echo 'Monthly';}?>
                                                                              </td>
                                                  <td  class="text-left">Rs. <?php echo number_format((float)$pma['plan_master']['CreditValue'], 2, '.', '');?></td>
                                                   <td class="text-left">Rs. <?php $sub_val =  get_subs_value($pma['plan_master']['PeriodType'],$pma['plan_master']['RentalAmount']); echo number_format((float)$sub_val, 2, '.', '');?></td>
                                                   <td  class="text-left">Rs. <?php  echo number_format((float)$pma['plan_master']['InboundCallCharge'], 2, '.', '');?>/ Min.</td> 
                                                   <td  class="text-left"> Rs. <?php echo number_format((float)$pma['plan_master']['InboundCallChargeNight'], 2, '.', '');?>/ Min.</td> 
                                                   <td class="text-left">Rs. <?php echo number_format((float)$pma['plan_master']['OutboundCallCharge'], 2, '.', '');?>/ Min.</td>
                                                   <td class="text-left"><?php echo  number_format((float)$pma['plan_master']['SMSCharge'], 2, '.', '');?></td>
                                                   <td class="text-left"><?php echo  number_format((float)$pma['plan_master']['EmailCharge'], 2, '.', '');?></td>
                                              </tr>
                                                </tbody>
                        ...
                        <div class="row">
                           ...
                           <script>
                              var xValues = ["Calls Connected", "Calls Not Connected"];
                     ...
                     {?>
                           <div class="col-md-6" style="margin-top: 10px;">
                              <h2 style="color:black;">Ticket By Source</h2>
                              <table class="table">
                                 <thead>
                                    <tr>
                                 ...
                                 <tbody>
                                    <tr>
                                       <td>Call</td>
                                       <td><?php if(!empty($ticket_by_source_call_array[0][0]['OPEN'])) {echo $ticket_by_source_call_array[0][0]['OPEN'];} else {echo 0;}?></td>
                                       <td><?php if(!empty($ticket_by_source_call_array[0][0]['CLOSE'])) {echo $ticket_by_source_call_array[0][0]['CLOSE'];} else {echo 0;}?></td>
                                       <td><?php if(!empty($ticket_by_source_call_array[0][0]['overdue'])) {echo $ticket_by_source_call_array[0][0]['overdue'];} else {echo 0;}?></td>
                                    </tr>
                                    <tr>
                                       <td>Email</td>
                                       <td>0</td>
                           ...
                           <div class="col-md-6"  style="margin-top: 10px;">
                              ...
                              <script>
                                 var xValues = ["Abandon", "Total Answered"];
                           ...
                           <div class="col-md-6"  style="margin-top: 10px;">
                              ...
                              <script>
                                 new Chart(document.getElementById("bar-chart-grouped1"), 
                                 {
                                    type: 'bar',
                                    data: {
                                    labels: [<?php echo strtoupper ($week_labels); ?>],
                                    datasets: [
                                       <?php 
                                    ...
                                    data: {
                                       ...
                                       datasets: [{
                                          ...
                                          backgroundColor: "#008000",
                                             data: [<?php foreach($tctm_today_row as $ttr) {print_r($ttr[0]['TOpen'].",".$ttr[0]['TClose']);};?>],
                                          //data: [345,789],
                                       }, {
                                          label: 'MTD',
                                          backgroundColor: "#90EE90",
                                          data: [<?php foreach($tctm_mtd_row as $tmr) {print_r($tmr[0]['TOpen'].",".$tmr[0]['TClose']);};?>],
                                          //data: [456,678],
                                       }
                                       ],
                                    },
            ...
            <div class="page-heading">
               <div class="container">
                  ...
                  {?> 
                        ...
                        <div class="row">
                           <div class="col-xs-12">
                              <?php 
                                 ...
                                 ?>
                              <h2 style="color:black;">Ledger Balance(FY <?php echo $financial_year;?>)</h2>
                           </div>
                        </div>
                        <?php 
                     ...
                     <div class="row">
                        <div class="col-xs-12">
                           <h2 style="color:black;">Usage Value Balance</h2>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                           <div class="info-tile info-tile-alt tile-green">
                              <div class="info">
