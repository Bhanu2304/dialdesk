...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MisDialReports/tagging_mis');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#"> MIS Report</a></li>
</ol>
    ...
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            ...
            <div class="panel-body">
                ...
                <?php echo $this->Form->create('MisDialReports',array('action'=>'index','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
