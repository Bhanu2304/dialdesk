...
<script>
    ...
    {
        window.location.href = '/dialdesk/ExposureExports/index_ledger';
    }
</script>
...
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}' style="margin-top:5px;">
            ...
            ?>
            <h4 class="page-header text-center"><span> <?= date('F',strtotime( date() . ' -1 day' ));?> </span> ( <span> <?= $financial_year;?></span> ) 
            <br><?php echo $this->Session->flash(); ?></h4>
            <p class="text-center">Sequence of Records ordered as client created newest to old.</p>
<!--                <form id="form_month" method="post" action="index_ledger">
                ...
                <table class="table" style="width:100%;font-size: 10px;">
                    ...
                    <tr>
                        ...
                        <th align="center" style="background: #CDB7B5;display: none1;" class="left_bord">Payment</th> 
                    </tr>
                    <?php $i =1;
                    ...
                    { //print_r($record);exit;
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td align="right" style="background: #EEE9E9;"><?php  $total_collected = $record['coll']+$record['advance']+$record['subs_coll']+$record['first_plan_coll']+$record['setupcoll']; echo number_format($total_collected,2);  $Collected=$Collected+$total_collected; ?></td>
                                <td align="right" style="background: #EEE9E9;" class="left_bord"><?php   $cl=round($op+$led_op-$record['coll']-$record['advance']-$record['subs_coll']-$record['first_plan_coll']-$record['setupcoll'],2);  $clsum= $clsum+$cl;
                                ...
                                ?></td>
                                <td align="right" style=" <?php if($open_bal<0) { echo "background-color:red;";} else {echo "background-color:#FAEBEB;";} ?>"><?php  echo $open_bal; $AB=$AB+$open_bal; ?></td>
                                ...
                                <td style="background: #EEE9E9;display: none1;">
