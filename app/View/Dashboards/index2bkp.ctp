...
?>
    <ol class="breadcrumb">                            
        ...
        <?php }?>
        <?php if(isset($viewType) && !empty($viewType)){ if(isset($viewType) && $viewType==="Custom"){ ?>
            ...
            <?php   } else { ?>
                <span style="margin-left:9%;font-size:20px;color:red;">Showing Result: <?php echo $viewType;?></span>
	...
	<div class="page-heading">            
        <h1><b>Billing</b></h1><br/> <h3><?php echo "From: $fromBilling To: $toBilling"; ?></h3>
