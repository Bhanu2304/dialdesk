...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MobileUploads/Whatsapp_transaction_report');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>MobileUploads/Whatsapp_transaction');
        }
...
<ol class="breadcrumb">                                
    ...
    <li><a href="#">Whatsapp Transaction </a></li>
    <li class="active"><a href="#">Whatsapp Transaction  Report</a></li>
</ol>
<div class="page-heading">            
    <h1>Whatsapp Transaction  REPORT</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Whatsapp Transaction Report</h2>
            </div>
