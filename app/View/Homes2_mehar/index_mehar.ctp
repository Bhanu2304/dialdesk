                                      ...
                                      <table class="fl-table">
                                         <thead>
                                              ...
                                              <th>Email Charges</th>
                                                ...
                                                <tbody>
                                              <tr>
                                                  <td class="text-left"><?php echo $pma['plan_master']['PlanName'];?></td>
                                                  <td  class="text-left"><?php echo $pma['plan_master']['PeriodType'];?></td>
                                                  <td  class="text-left"><?php echo $pma['plan_master']['CreditValue'];?></td>
                                                   <td class="text-left"><?php echo $pma['plan_master']['RentalAmount'];?></td>
                                                   <td  class="text-left"><?php echo $pma['plan_master']['InboundCallCharge'];?></td> 
                                                   <td  class="text-left"> Rs./Minutes<?php echo $pma['plan_master']['InboundCallChargeNight'];?></td> 
                                                   <td class="text-left">Rs./Minutes <?php echo $pma['plan_master']['OutboundCallCharge'];?></td>
                                                   <td class="text-left"><?php echo $pma['plan_master']['SMSCharge'];?></td>
                                                   <td class="text-left"><?php echo $pma['plan_master']['EmailCharge'];?></td>
                                              </tr>
                                                </tbody>
