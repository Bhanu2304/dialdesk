...
for(; i<5; i++)
{
	...
	$.post("/dialdesk/OutboundCategories/getChild",
        ...
        // console.log(params);
        $.post("/dialdesk/OutboundCategories/getResolution",
        params,
                        ...
                        <?php
                          if(!empty($ecr)){
                            ...
                            for($i =0; $i <1; $i++)
                            {
                                ...
                                echo "<div class=\"col-sm-2\">".$this->Form->input('Category1', array('label'=>false,'options'=>$options,'empty'=>'Select Category','class'=>'form-control scen','required'=>true,'onChange'=>'outbound_getChild(this.id)')).
