    ...
    <div class="container-fluid">
        <div data-widget-group="group1">
            <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                ...
                <?php echo $this->Form->create('MisAndReportMatrixs',array('action'=>'save_report_matrix','class'=>'form-horizontal row-border','onsubmit'=>'return validReportMatrix()')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <?php echo $this->form->input('user_name',array('label'=>false,'value'=>isset ($matrixArr['ReportMatrixMaster']['user_name']) ? $matrixArr['ReportMatrixMaster']['user_name'] : "",'id'=>'user_name','class'=>'form-control','size'=>'39'));?>
                                </div>

                                <label class="col-sm-2 control-label">Designation</label>
                                <div class="col-sm-4">
                                        <?php echo $this->form->input('user_designation',array('label'=>false,'value'=>isset ($matrixArr['ReportMatrixMaster']['user_designation']) ? $matrixArr['ReportMatrixMaster']['user_designation'] : "",'id'=>'user_designation','class'=>'form-control','size'=>'39'));?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <?php echo $this->form->input('user_mobile',array('label'=>false,'maxlength'=>'10','onkeypress'=>'return checkCharacter(event,this)','value'=>isset ($matrixArr['ReportMatrixMaster']['user_mobile']) ? $matrixArr['ReportMatrixMaster']['user_mobile'] : "",'id'=>'user_mobile','class'=>'form-control','size'=>'39'));?>
                                </div>

                                <label class="col-sm-2 control-label">Email</label>
                                <div class="col-sm-4">
                                    <?php echo $this->form->input('user_email',array('label'=>false,'value'=>isset ($matrixArr['ReportMatrixMaster']['user_email']) ? $matrixArr['ReportMatrixMaster']['user_email'] : "",'id'=>'user_email','class'=>'form-control','size'=>'39'));?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <?php echo $this->Form->input('report', array('label'=>false,'value'=>isset ($matrixArr['ReportMatrixMaster']['report']) ? $matrixArr['ReportMatrixMaster']['report'] : "",'options'=>$report,'empty'=>'Select Report','class'=>'form-control','id'=>'report')); ?> 
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select name="data[report_type]" class="form-control" id="report_type" onchange="return showReport(this);" >
                                        ...
                                        <option <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_type']=='monthly'){echo 'selected="selected"';}?> 
                                        value="monthly">Monthly Report</option>
                                        <option <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_type']=='weekly'){echo 'selected="selected"';}?>
                                            value="weekly">Weekly Report</option>
                                        <option <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_type']=='daily'){echo 'selected="selected"';}?> 
                            ...
                            <div class="form-group" id="month" style="display:none;">
                                ...
                                <div class="col-sm-4">
                                        <?php echo $this->form->input('monthwise',array('label'=>false,'value'=>isset ($matrixArr) ? $matrixArr['ReportMatrixMaster']['report_value'] : "",'id'=>'monthwise','class'=>'date-picker form-control','placeholder'=>'Select Month'));?> 
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="day" style="display:none;">
                                ...
                                <div class="col-sm-4">
                                    <select name="data[daywise]" class="form-control" id="daywise" >
                                        ...
                                        <option  <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']=='monday'){echo 'selected="selected"';}?> value="monday">Monday</option>
                                        <option  <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']=='tuesday'){echo 'selected="selected"';}?> value="tuesday">Tuesday</option>
                                        <option  <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']=='wednesday'){echo 'selected="selected"';}?> value="wednesday">Wednesday</option>
                                        <option  <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']=='thursday'){echo 'selected="selected"';}?> value="thursday">Thursday</option>
                                        <option  <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']=='friday'){echo 'selected="selected"';}?> value="friday">Friday</option>
                                        <option  <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']=='saturday'){echo 'selected="selected"';}?> value="saturday">Saturday</option>
                                        <option  <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']=='sunday'){echo 'selected="selected"';}?> value="sunday">Sunday</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="hour" style="display:none;">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="data[hourwise]" class="form-control" id="hourwise" >
                                        ...
                                        <?php for($i=1;$i<=24;$i++){?>
                                        <option <?php if(isset($matrixArr) && $matrixArr['ReportMatrixMaster']['report_value']==$i){echo 'selected="selected"';}?> value="<?php echo $i;?>"><?php echo $i;?></option>
                                        <?php }?>
                                    </select>
                                                -->
                                </div>
                                ...
                                <div class="form-group" id="send_medium1" style="display:none;">
                                    ...
                                    <?php if(isset($matrixArr['ReportMatrixMaster']['report_value'])){$exp=explode(",",$matrixArr['ReportMatrixMaster']['send_type']);}?>
                                    <div class="col-sm-8">
                                       
                                        <div class="checkbox checkbox-inline checkbox-black">
                                            <label>
                                                <input type="checkbox" <?php if(isset($matrixArr['ReportMatrixMaster']['report_value']) && in_array('sms',$exp)){echo "checked='checked'";}?> name="send_type[]"  value="sms" />
                                                SMS
                                            </label>
                                        </div>
                                        ...
                                        <div class="checkbox checkbox-inline checkbox-black">
                                            <label>
                                                <input type="checkbox" <?php if(isset($matrixArr['ReportMatrixMaster']['report_value']) && in_array('email',$exp)){echo "checked='checked'";}?> name="send_type[]" value="email" />
                                                Email
                                            </label>
                                        </div>
                                    </div>
                        		...
                        		<?php echo $this->form->hidden('updateid',array('label'=>false,'value'=>isset ($matrixArr['ReportMatrixMaster']['id']) ? $matrixArr['ReportMatrixMaster']['id'] : ""));?>
