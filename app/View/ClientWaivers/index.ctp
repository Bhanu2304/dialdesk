...
<?php echo $this->Form->create('ClientWaivers',array('action'=>'client_wise_waiver_creation','id'=>'clientwaiver_form',"class"=>"form-horizontal")); ?>
<div class="page-heading margin-top-head">            
    <h2>Add Balance</h2>
    <div class="page-heading margin-top-head">
        
       <?php echo $this->Form->input('clientID',array('label'=>false,'onchange'=>'createClientWaiver();','options'=>$client,'value'=>isset($clientid)?$clientid:"",'id'=>'slclient','empty'=>'Select Client','class'=>'form-control client-box','required'=>true)); ?>
...
<div class="container-fluid">
    <div data-widget-group="group1">
        ...
        <?php if(isset($waiver) && empty($waiver)){?>
        ...
        <div class="panel-body">
            <div class="panel-body">
                ...
                <?php if(empty($waiver)) { echo "Please Create Plan First";} ?>
            <?php 
//                    $count = count($Fields2);
