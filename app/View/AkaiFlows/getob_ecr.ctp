...
{
    $data = array_merge(array('All'=>'All'),$data);
    ...
    echo $this->Form->input('ObEscalations.'.$newType,array('label'=>false,'options'=>$data,'empty'=>'Select','class'=>'form-control','onchange'=>$function."(this.value,'".$this->webroot."AkaiFlows/getobEcr','".$Label."','".$divtype."','')"));
    echo '</div>';
}
