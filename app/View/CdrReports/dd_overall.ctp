...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>CdrReports/dd_overall');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>CdrReports/dd_overall');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">SLA OverAll Slot Wise</a></li>
</ol>
<div class="page-heading">            
    <h1>SLA OverAll Slot Wise</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>SLA OverAll Slot Wise Reports</h2>
            </div>
