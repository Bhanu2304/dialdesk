...
<div class="container-fluid">
	...
	<td><?php echo $dt[0]['WrapTime'];?></td>
        <td><?php echo $dt[0]['ParkedTime'];?></td>
            ...
            <td><a href="https://dialdesk.co.in/download-recording/download.php?mode=DD&filename=<?php echo  $dt['t2']['LeadId'];?>&agent=<?php echo $dt[t2]['Agent'];?>">Download Recording</a></td>
            <!--
