...
function validateExport(url){
    ...
    if(fdate ===""){
        ...
        if(url ==="download"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>CdrReports/abandon_call_excel');
        }
        if(url ==="view"){
            $('#validate-form').attr('action','<?php echo $this->webroot;?>CdrReports/abandon_call');
        }
...
<ol class="breadcrumb">                                
    ...
    <li class="active"><a href="#">Abandon Call Data</a></li>
</ol>
<div class="page-heading">            
    <h1>Abandon Call Data</h1>
</div>
<div class="container-fluid">
    <div data-widget-group="group1">
        <div class="panel panel-default" data-widget='{"draggable": "false"}'>
            <div class="panel-heading">
                <h2>Abandon Call Data</h2>
            </div>
