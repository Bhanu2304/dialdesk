      <script>
function gampaignDetails(){
    $("#campaign_id_form").submit();
}
    
function getObecrChild(id)
{
    
var i;
if(id=='ObSrCreationsCategory1') i = 1;
if(id=='ObSrCreationsCategory2') i = 2;
if(id=='ObSrCreationsCategory3') i = 3;
if(id=='ObSrCreationsCategory4') i = 4;
if(id=='ObSrCreationsCategory5') i = 5;
var labeld = i;
for(; i<5; i++)
{
	try{
		document.getElementById("ObSrCreationsCategory"+(i+1)).value;					
	...
	var parent= document.getElementById("ObSrCreationsCategory1").value;
	var label = 1;
	...
	try{
		 ...
		 parent = document.getElementById("ObSrCreationsCategory2").value;
		 label =2;
		 
		 
		 parent = document.getElementById("ObSrCreationsCategory3").value;
		 label =3;
		
		
		 parent = document.getElementById("ObSrCreationsCategory4").value;
		 label =4;
		 
		 
		 parent = document.getElementById("ObSrCreationsCategory5").value;
		 label =5;	
	...
	$.post("/dialdesk/ObSrCreations/getChild",
        {
          Parent: parent,
          Label: label
        },
    ...
    <ol class="breadcrumb">                                
        ...
        <li class="active"><a href="#">Add Outbound SR Details</a></li>
    </ol>
    <div class="page-heading">            
        <h1>Add Outbound SR Details</h1>
    </div>
    <div class="container-fluid">
            ...
            <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                <div class="panel-heading">
                    ...
                    <div>
                        ...
                        <?php echo $this->Form->create('ObSrCreations',array('action'=>'index','id'=>'campaign_id_form',"class"=>"form-horizontal row-border",'data-parsley-validate')); ?>
                <div class="form-group">
                        <label class="col-sm-0 control-label"></label>
                        <div class="col-sm-3">
                            <?php echo $this->Form->input('campaign',array('label'=>false,'options'=>$Campaign,'onchange'=>'gampaignDetails();','empty'=>'Select Campaign Name','class'=>'form-control','required'=>true ));?>
                        </div>
                </div> 
        ...
        <?php echo $this->Form->create('ObSrCreations',array('action'=>'save_srcreation','id'=>'validate-form','class'=>'form-horizontal row-border','data-parsley-validate')); ?>
        <!--
        <div class="form-group">
        ...
        -->
        <table id="cat1" table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables">
        <?php
         if(!empty($ecr)){
	$keys = array_keys($ecr);
	for($i =0; $i <1; $i++){
