...
<?php //echo $this->Form->create('Homes1',array('action'=>'index','id'=>'view_client_form')); ?>
<form action="/dialdesk/homes" id="view_client_form" method="post" accept-charset="utf-8">
        <div class="col-sm-3">
        ...
        <div class="container">
                <div class="row">
                    <div class="col-md-6"  style="margin-top: 10px;">
                        ...
                        <canvas id="myChart" style="width:100%;background: black;"></canvas>
                    ...
                    <div class="col-md-12"  style="margin-top: 10px;">
                        ...
                        <?php 
                                ...
                                //print_r($graph_date_wise);
                        ?>
                    
                    <canvas id="myChart4" style="width:100%;height:450px;background: black;"></canvas>
...
<script>
      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          ...
          labels: [<?php foreach($graph_date_wise as $dy) {print_r("'".date_format(date_create($dy[0][0]['gdate']),"d-M-Y")."',");} ?>],
          datasets: [{
                    label: 'Total Ans',
                    backgroundColor: "#87CEFA",
                    data: [<?php foreach($graph_date_wise as $dy) {print_r($dy[0][0]['Total'].",");} ?>],
                }, {
                    label: 'Abondon',
                    backgroundColor: "#6495ED",
                    data: [<?php foreach($graph_date_wise as $dy) {print_r($dy[0][0]['Abandon'].",");} ?>],
                }, {
                    label: 'None',
                    backgroundColor: "#000080",
                    data: [<?php foreach($graph_date_wise as $dy) {print_r($dy[0][0]['Answered'].",");} ?>],
                }
                ],
        },
      options: {
            ...
            yAxes: [{
              ...
              ticks: {
                        ...
                        callback:((value, index, ticks) => {
                          return value * 0.1 + '%'; // convert it to percentage
                        }),
                      },
                    scaleLabel: {
                                    display: true,
          ...
          legend: { position: 'bottom' },
                    ...
                    <div class="col-md-6"  style="margin-top: 10px;">                        
                    <?php 
                     $wc11 = $week1[0][0]['TComplaint'];
                     $wc12 = $week2[0][0]['TComplaint'];
                     $wc13 = $week3[0][0]['TComplaint'];
                     $wc14 = $week4[0][0]['TComplaint'];
                     $week_mtd15 = $week_mtd[0][0]['TComplaint'];

                     $w21 = $week1[0][0]['TRequest'];
                     $w22 = $week2[0][0]['TRequest'];
                     $w23 = $week3[0][0]['TRequest'];
                     $w24 = $week4[0][0]['TRequest'];
                     $week_mtd25 = $week_mtd[0][0]['TRequest'];

                     $w31 = $week1[0][0]['TEnquiry'];
                     $w32 = $week2[0][0]['TEnquiry'];
                     $w33 = $week3[0][0]['TEnquiry'];
                     $w34 = $week4[0][0]['TEnquiry'];
                     $week_mtd35 = $week_mtd[0][0]['TEnquiry'];
                    
                    ?>
                        <canvas id="bar-chart-grouped1" style="background: black;"></canvas>
                        ...
                        <script>
                            new Chart(document.getElementById("bar-chart-grouped1"), 
                            {
                                type: 'bar',
                                data: {
                                labels: ["w1", "w2", "w3", "w4", "MTD"],
                                datasets: [
                                    {
                                    label: "Enquiry",
                                    backgroundColor: "#008000",
                                    data: [<?php echo $w31.",".$w32.",".$w33.",".$w34.",".$week_mtd35?>]
                                    }, {
                                    label: "Complaint",
                                    backgroundColor: "#006400",
                                    data: [<?php echo $w11.",".$w12.",".$w13.",".$w14.",".$week_mtd15?>]
                                    }
                                    , {
                                    label: "Request",
                                    backgroundColor: "#90EE90",
                                    data: [<?php echo $w21.",".$w22.",".$w23.",".$w24.",".$week_mtd25?>]
                                    }
                                ]
                                },
                                options: {
                    ...
                    <div class="col-md-6"  style="margin-top: 10px;">
                        ...
                        <canvas id="T_MTD" style="width:100%;background: black;"></canvas>                
                            <script>
                    ...
                    <div class="col-md-6"  style="margin-top: 10px;">
                            ...
                            <canvas id="myChartopenTicket" style="background: black;"></canvas>
                    ...
                    <div class="col-md-6" style="margin-top: 10px;">                                    
                        ...
                        <canvas id="myChartcloseTicket" style="background: black;"></canvas>
