...
<table class="table">
    ...
    <tbody>
            ...
            <tr  align="center">
                    ...
                    <td><?php echo $this->Html->link(__('PDF'), array('controller'=>'InitialInvoices','action' => 'view_proforma_pdf','?'=>array('id'=>base64_encode($id)), 'ext' => 'pdf', 'ProformaInvoice'),array('target'=>'_blank')); ?></td>

                    <td>
                            <?php echo $this->Html->link('View',
                    array('controller'=>'InitialInvoices','action'=>'view_bill','?'=>array('id'=>$id,'back_url'=>'view'),'full_base' => true)); ?>
                            <?php echo $this->Html->link('Edit',
                    array('controller'=>'InitialInvoices','action'=>'edit_proforma','?'=>array('id'=>$id),'full_base' => true)); ?>
