    ...
    <div data-widget-group="group1">
		...
		<div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div>
            ...
            <div class="panel-body">
                <?php echo $this->Form->create('ScenarioAutomates',array("class"=>"form-horizontal","action"=>"call_summary_out")); ?>
                                                        ...
                                                        <tbody>
                                                             <?php  $i =1; foreach($scen_data as $d): $id = $d['ScenarioAutomate']['id']; ?>
                                                                <tr >
                                                                    ...
                                                                    <td>
                                                                        <a href="#" onclick="deleteData('<?php echo $this->webroot;?>ScenarioAutomates/delete_alert2?id=<?php echo $id;?>')" >
