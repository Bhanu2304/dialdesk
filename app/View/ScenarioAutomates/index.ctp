...
<ol class="breadcrumb">                                
    ...
    <li><a href="#">Bill Risk Mgt</a></li>
    <li class="active"><a href="#">Scenario Report Automation</a></li>
</ol>
<div class="page-heading">                                           
<h1>Scenario Report Automation</h1>
</div>
    ...
    <div data-widget-group="group1">
		...
		<div class="panel-ctrls" data-actions-container="" data-action-collapse='{"target": ".panel-body"}'></div>
            ...
            <div class="panel-body">
                <?php echo $this->Form->create('ScenarioAutomates',array("class"=>"form-horizontal")); ?>
                                                        ...
                                                        <tbody>
                                                             <?php  $i =1; foreach($scen_data as $d): $id = $d['ScenarioAutomate']['id']; ?>
                                                                <tr >
                                                                    ...
                                                                    <td>
                                                                        <a href="#" onclick="deleteData('<?php echo $this->webroot;?>ScenarioAutomates/delete_alert?id=<?php echo $id;?>')" >
