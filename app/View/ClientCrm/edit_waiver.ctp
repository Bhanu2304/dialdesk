...
$rental = array($waiver['Waiver']['RentalPeriod']=>$waiver['Waiver']['RentalPeriod']);
$Fields = array('FreeValue'=>array('label'=>'Free Value','type'=>'number','value'=>'','required'=>'0','readonly'=>'0','function'=>''),
                'PeriodType'=>array('label'=>'Period Type','type'=>'select','value'=>$rentalPeriod,'required'=>'0','readonly'=>'0','function'=>array('onChange'=>"getPeriod(this.value)")),
                'RentalPeriod'=>array('label'=>'Free Rental Period','type'=>'select','value'=>'','required'=>'0','readonly'=>'0','function'=>''),
                'InboundCall'=>array('label'=>'Inbound Call Minute','type'=>'number','value'=>'','required'=>'0','readonly'=>'0','function'=>''),
                'OutboundCall'=>array('label'=>'Outbound Call Minute','type'=>'nmber','value'=>'','required'=>'0','readonly'=>'0','function'=>''),
                'MissCall'=>array('label'=>'Miss Call minute','type'=>'number','value'=>'','required'=>'0','readonly'=>'0','function'=>''),
                'VFOCall'=>array('label'=>'Vfo Call Minute','type'=>'number','value'=>'','required'=>'0','readonly'=>'0','function'=>''),
                'SMS'=> array('label'=>'SMS Minute','type'=>'number','value'=>'','required'=>'0','readonly'=>'0','function'=>''),
                'Email'=>array('label'=>'Free Email','type'=>'number','value'=>'','required'=>'0','readonly'=>'0','function'=>'') 
                );       
            ...
            <?php 
                    ...
                    echo '<div class="form-group">';
                        for(; $i<$count; $i++)
                        {
                            ...
                            if($type=='select')
                            {
                                echo $this->Form->input($fieldName, array_merge(array('label'=>false,'options'=>$option,'value'=>$waiver['Waiver'][$fieldName],'class'=>'form-control'),$validate));
                            }
                            
                            else if($type=='time')
                            {
                                echo $this->Form->input($fieldName, array_merge(array('label'=>false,"onClick"=>"displayDatePicker(\''.$fieldName.'\');",'value'=>$waiver['Waiver'][$fieldName],'class'=>'form-control'),$validate));
                            }
                            
                            else if($type=='number')
                            {
                                echo $this->Form->input($fieldName, array_merge(array('label'=>false,'onkeypress'=>'return checkCharacter(event,this)','value'=>$waiver['Waiver'][$fieldName],'class'=>'form-control'),$validate));
                            }
                            else if($type=='area')
                            {
                                echo $this->Form->textArea($fieldName, array_merge(array('label'=>false,'value'=>$waiver['Waiver'][$fieldName],'class'=>'form-control'),$validate));
                            }
                            else if($type=='file')
                            {
                            ...
                            {
                                echo $this->Form->input($fieldName, array_merge(array('label'=>false,'value'=>$waiver['Waiver'][$fieldName],'class'=>'form-control'),$validate));
                            }
                        echo '</div>';
                    ...
                    echo '</div>';
                 ?>
            <input type="hidden" name="id" value="<?php echo $waiver['Waiver']['Id']; ?>" />
        </div>
