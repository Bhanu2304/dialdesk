...
if(is_array($data) && !empty($data))
{
    ...
    echo $this->Form->input('ObEscalations.'.$newType,array('label'=>false,'options'=>$data,'value'=>isset($slt)?$slt:"",'empty'=>'Select','class'=>'form-control','onchange'=>$function."(this.value,'".$this->webroot."ObEscalations/get_edit_ecr','".$Label."','".$divtype."')"));
    echo '</div>';
}
