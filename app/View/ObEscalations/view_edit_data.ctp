...
<script>
    $(document).ready(function(){
		<?php if($data1['category'] !=""){?>
            getTypeOb("<?php echo $data1['campaignid'].'@@'.$data1['campaignidName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","1","ae","<?php if($data1['categoryName'] ==="All"){echo 'All@@'.$data1['categoryName'];}else{ echo $data1['category'].'@@'.$data1['categoryName'];}?>");
        <?php }?>
        <?php if($data1['type'] !=""){?>
            getTypeOb("<?php echo $data1['category'].'@@'.$data1['categoryName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","2","ae","<?php if($data1['typeName'] ==="All"){echo 'All@@'.$data1['typeName'];}else{ echo $data1['type'].'@@'.$data1['typeName'];}?>");
        <?php }?>
        <?php if($data1['subtype'] !=""){?>
            getTypeOb("<?php echo $data1['type'].'@@'.$data1['typeName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","3","ae","<?php if($data1['subtypeName'] ==="All"){echo 'All@@'.$data1['subtypeName'];}else{echo $data1['subtype'].'@@'.$data1['subtypeName'];}?>");
        <?php }?>
        <?php if($data1['subtype1'] !=""){?>
            getTypeOb("<?php echo $data1['subtype'].'@@'.$data1['subtypeName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","4","ae","<?php if($data1['subtype1Name'] ==="All"){echo 'All@@'.$data1['subtype1Name'];}else{echo $data1['subtype1'].'@@'.$data1['subtype1Name'];}?>");
        <?php }?>
        <?php if($data1['subtype2'] !=""){?>
            getTypeOb("<?php echo $data1['subtype1'].'@@'.$data1['subtype1Name'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","5","ae","<?php if($data1['subtype2Name'] ==="All"){echo 'All@@'.$data1['subtype2Name'];}else{echo $data1['subtype2'].'@@'.$data1['subtype2Name'];}?>");
        <?php }?>
    });
...
<?php
if(isset($data1['campaignidName']) && $data1['campaignidName'] ==="All"){
    $selectCampaignid= isset($data1['campaignid'])?'All@@'.$data1['campaignidName']:"";
}
else{
  $selectCampaignid= isset($data1['campaignid'])?$data1['campaignid'].'@@'.$data1['campaignidName']:"";  
}
?>
    <?php echo $this->Form->create('ObEscalations',array('action'=>'update_alert_esclation','onsubmit'=>'return checkDefineAlertEdit();','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="horizontal-form">
                        <div class="form-group"> 
                            ...
                            <div class="col-sm-4">
								<?php echo $this->Form->input('campaignid',array('label'=>false,'class'=>'form-control','value'=>$selectCampaignid,'options'=>$Campaign,'empty'=>'Select','onchange'=>"getTypeOb(this.value,'get_edit_ecr','1','ae')",'required'=>true)); ?>
                            </div>
                            <div id="aetype"></div>
                            <div id="aesubtype"></div>
                            <div id="aesubtype1"></div>
                            <div id="aesubtype2"></div>
							<div id="aesubtype3"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php echo $this->Form->input('email',array('type'=>'text','label'=>false,'id'=>'EscalationsEmailEdit','value'=>isset($data1['email'])?$data1['email']:"",'class'=>'form-control','placeholder'=>'Email','required'=>false)); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
		<?php if($data1['category'] !=""){?>
            getTypeOb("<?php echo $data1['campaignid'].'@@'.$data1['campaignidName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","1","de","<?php if($data1['categoryName'] ==="All"){echo 'All@@'.$data1['categoryName'];}else{echo $data1['category'].'@@'.$data1['categoryName'];}?>");
        <?php }?>
        <?php if($data1['type'] !=""){?>
            getTypeOb("<?php echo $data1['category'].'@@'.$data1['categoryName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","2","de","<?php if($data1['typeName'] ==="All"){echo 'All@@'.$data1['typeName'];}else{echo $data1['type'].'@@'.$data1['typeName'];}?>");
        <?php }?>
        <?php if($data1['subtype'] !=""){?>
            getTypeOb("<?php echo $data1['type'].'@@'.$data1['typeName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","3","de","<?php if($data1['subtypeName'] ==="All"){echo 'All@@'.$data1['subtypeName'];}else{echo $data1['subtype'].'@@'.$data1['subtypeName'];}?>");
        <?php }?>
        <?php if($data1['subtype1'] !=""){?>
            getTypeOb("<?php echo $data1['subtype'].'@@'.$data1['subtypeName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","4","de","<?php if($data1['subtype1Name'] ==="All"){echo 'All@@'.$data1['subtype1Name'];}else{echo $data1['subtype1'].'@@'.$data1['subtype1Name'];}?>");
        <?php }?>
        <?php if($data1['subtype2'] !=""){?>
            getTypeOb("<?php echo $data1['subtype1'].'@@'.$data1['subtype1Name'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","5","de","<?php if($data1['subtype2Name'] ==="All"){echo 'All@@'.$data1['subtype2Name'];}else{echo $data1['subtype2'].'@@'.$data1['subtype2Name'];}?>");
        <?php }?>
    });
    
    function checkDefineEsclationEdit(){
    var alertType=$("#ObEscalationsAlertOnTab2Edit").val();
    var mobil=$("#ObEscalationsMobileNoTab2Edit").val();
    var email=$("#ObEscalationsEmailTab2Edit").val();
    
    if(alertType ==="sms" &&  mobil ===""){
        alert('Please enter mobile no.');
        $("#ObEscalationsMobileNoTab2Edit").focus();
        return false;
    }
    else if(alertType ==="email" &&  email ===""){
        alert('Please enter email id.');
        $("#ObEscalationsEmailTab2Edit").focus();
        return false;
    }
    else if(alertType ==="both" &&  mobil ===""){
        alert('Please enter mobile no.');
...
?>
    ...
    <?php echo $this->Form->create('ObEscalations',array('action'=>'update_alert_esclation','onsubmit'=>'return checkDefineEsclationEdit();','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                        ...
                        <div class="form-group"> 
                            ...
                            <div class="col-sm-4">
                             ...
                             <label class="col-sm-2 control-label">Campaign</label>
                            <div class="col-sm-4">
								<?php echo $this->Form->input('campaignid',array('label'=>false,'class'=>'form-control','value'=>$selectCampaignid,'options'=>$Campaign,'empty'=>'Select','onchange'=>"getTypeOb(this.value,'get_edit_ecr','1','de')",'required'=>true)); ?>
                            </div>
                            <div id="detype"></div>
                            <div id="desubtype"></div>
                            <div id="desubtype1"></div>
                            <div id="desubtype2"></div>
                            <div id="desubtype3"></div>
                        </div>
                        <div class="form-group">
...
<script>
    $(document).ready(function(){
		<?php if($data2['category'] !=""){?>
            getTypeOb("<?php echo $data2['campaignid'].'@@'.$data2['campaignidName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","1","be","<?php if($data2['categoryName'] ==="All"){echo 'All@@'.$data2['categoryName'];}else{echo $data2['category'].'@@'.$data2['categoryName'];}?>");
        <?php }?>
        <?php if($data2['type'] !=""){?>
            getTypeOb("<?php echo $data2['category'].'@@'.$data2['categoryName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","2","be","<?php if($data2['typeName'] ==="All"){echo 'All@@'.$data2['typeName'];}else{echo $data2['type'].'@@'.$data2['typeName'];}?>");
        <?php }?>
        <?php if($data2['subtype'] !=""){?>
            getTypeOb("<?php echo $data2['type'].'@@'.$data2['typeName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","3","be","<?php if($data2['subtypeName'] ==="All"){echo 'All@@'.$data2['subtypeName'];}else{echo $data2['subtype'].'@@'.$data2['subtypeName'];}?>");
        <?php }?>
        <?php if($data2['subtype1'] !=""){?>
            getTypeOb("<?php echo $data2['subtype'].'@@'.$data2['subtypeName'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","4","be","<?php if($data2['subtype1Name'] ==="All"){echo 'All@@'.$data2['subtype1Name'];}else{echo $data2['subtype1'].'@@'.$data2['subtype1Name'];}?>");
        <?php }?>
        <?php if($data2['subtype2'] !=""){?>
            getTypeOb("<?php echo $data2['subtype1'].'@@'.$data2['subtype1Name'];?>","<?php echo $this->webroot.'ObEscalations/get_edit_ecr';?>","5","be","<?php if($data2['subtype2Name'] ==="All"){echo 'All@@'.$data2['subtype2Name'];}else{echo $data2['subtype2'].'@@'.$data2['subtype2Name'];}?>");
        <?php }?>
    });
</script>

<?php
if(isset($data2['campaignidName']) && $data2['campaignidName'] ==="All"){
    $selectCampaignid= isset($data2['campaignid'])?'All@@'.$data2['campaignidName']:"";
}
else{
  $selectCampaignid= isset($data2['campaignid'])?$data2['campaignid'].'@@'.$data2['campaignidName']:"";  
}
?>
    <?php echo $this->Form->create('ObEscalations',array('action'=>'update_customer_smstext','class'=>'form-horizontal row-border','style'=>'margin-right:20px;'));?>                                                                                           
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="horizontal-form">
                        <div class="form-group">
                            ...
                            <label class="col-sm-2 control-label">Campaign</label>
                            <div class="col-sm-4">
								<?php echo $this->Form->input('campaignid',array('label'=>false,'class'=>'form-control','value'=>$selectCampaignid,'options'=>$Campaign,'empty'=>'Select','onchange'=>"getTypeOb(this.value,'get_edit_ecr','1','be')",'required'=>true)); ?>
                            </div>
                            <div id="betype"></div>
                            <div id="besubtype"></div>
                            <div id="besubtype1"></div>
                            <div id="besubtype2"></div>
							<div id="besubtype3"></div>
                        </div>
