                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="exap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $i++; ?></td>
                                <td><?php echo date_format(date_create($post['pu']['date_time']),'d M Y H:i:s'); ?></td>
                                <td><?php echo $post['pu']['process_update']; ?></td>
                                <td><?php echo $post['pu']['company_name']; ?></td>
                                <td><?php echo $post['pu']['type']; ?></td>
                                <td><?php echo date_format(date_create($post['pu']['valid_from']),'d M Y');?></td>
                                <td><?php echo date_format(date_create($post['pu']['valid_till']),'d M Y');?></td>
                                <td><?php echo $post['0']['Total'];?></td>
                                
                                <td>
                                    <a href="#" onclick="deleteData('<?php echo $this->webroot;?>ProcessUpdates/delete_data?id=<?php echo $post['pu']['id'];?>')" >
