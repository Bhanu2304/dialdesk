...
class OutboundsController extends AppController{
	...
	public $uses=array('CampaignName','PurposeCampaign','EcrCampaign','CampaignMaster','Obup','ObAllocationMaster');
	...
	public function add_campaign() {
            ...
            foreach($cmp as $row){
                ...
                $campaign_header[]=array('campaign'=>$cmpName,'field'=>$field,'campaignid'=>$cmpId);
            }
