	...
	{	
            ...
            else if($this->request->data['action']=='add')
            {
                ...
                if($this->request->is('Post'))
                {
                        ...
                        $msg = $this->request->data['first_name'];
                        $optionType = $this->request->data['optionType'];
                        $parent_id = $this->request->data['parentid'];
                        $this->Ivr->save(array('OptionType'=>$optionType,'Msg'=>$msg,'parent_id'=>$parent_id,'clientId'=>$ClientId,'createdate'=>date('Y-m-d H:i:s')));
