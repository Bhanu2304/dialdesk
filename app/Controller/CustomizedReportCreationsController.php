<?php
class CustomizedReportCreationsController extends AppController{
	public $helpers = array('Html', 'Form','Js');
	public $components = array('RequestHandler');
	public $uses=array('EcrRecord','FieldMaster','CloseFieldData','ReportTabMaster','ReportHeaderMaster');
