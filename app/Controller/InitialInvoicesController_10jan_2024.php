...
{
    // $response_url = Router::url('/', true).'Initial/paymentResponse';
     ...
     $response_url ="https://dialdesk.co.in/dialdesk/Initial/paymentResponse";
            ...
            //$key="pxEIPNVQg3LCIZUdWx4pNQ4bItLydFrEJ+8ajhjUfEY=";
                        ...
                        $final=array();
                        $final['encryptText']=$value;
                        $result=JWT :: encode($final,$key);
                        $val3=$result;
                        $logininit['loginRequest']=$val3;
                        $val2=json_encode($logininit);
                        ...
                        $decrypt = JWT::decode($PAYLOAD, $key,array('HS256'));
                        //print_r($decrypt);
                        ...
                        $third=$second['uniqueLoginKey'];
                        $fourth=$second['sessionKey'];
                        $fifth=$fourth;
                        ...
                        $value1=json_encode($OrderAPI);
                       
                        $value4['encryptText']=$value1;

                        #print_r($value4);die;
                       
                        $fss=$value4; 
                        //print_r($value4);exit;
                        $unique=JWT :: encode($value4,$third);
                      
                        $request["mediaBasedPostRequest"]=$unique;
                        ...
                        $dec1=JWT :: decode($response,$third,array('HS256'));
