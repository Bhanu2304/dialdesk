<?php
	class DataAllocationsController extends AppController{
	...
	public function index() {
		...
		if($this->request->is("POST")){
			$allocationid=$this->request->data['DataAllocations']['AllocationName'];
			$Count=$this->request->data['DataAllocations']['Count'];
			$allocated=$this->request->data['DataAllocations']['Allocated'];
