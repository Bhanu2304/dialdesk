...
#	echo "\n";
	...
	if ($file_download < 1)
		...
		$ASCII_text .="<th>"._QXZ("USER NAME",25)."</th> <th>"._QXZ("ID",8)."</th> <th>"._QXZ("CALLS",8)."</th> <th>"._QXZ("TIME CLOCK",10)."</th> <th>"._QXZ("LOGIN TIME",10)."</th> <th> "._QXZ("WAIT",10)." </th> <th> "._QXZ("WAIT",8)."% </th> <th> "._QXZ("TALK",10)." </th> <th> "._QXZ("TALK TIME",9)." %</th> <th> "._QXZ("DISPO",10)." </th> <th> "._QXZ("DISPOTIME",9)." %</th> <th> "._QXZ("PAUSE",10)." </th> <th> "._QXZ("PAUSETIME",9)." %</th> <th> "._QXZ("DEAD",10)." </th> <th> "._QXZ("DEAD TIME",9)." % </th> <th> "._QXZ("CUSTOMER",10)." </th> <th> "._QXZ("Login",10)." </th> <th> "._QXZ("Logout",10)." </th> <th> "._QXZ("ACHT",10)." </th>    $sub_statusesHTML";
		$ASCII_text .="</tr>";	
...
$LogoutT = $Logout[0]==''?"00:00:00":"$Logout[0]";
		...
		if ($file_download < 1)
			...
			if ($atdr_login_logout_user_link > 0)
				{
				$Toutput = "<tr><td> $Sname[$m] </td><td> $Suser[$m]</td><td> $Scalls[$m] </td><td> $StimeTC[$m]$TCuserAUTOLOGOUT</td><td> $Stime[$m] </td><td>$park_AGENT_INFO $Swait[$m] </td><td> $Swaitpct[$m] </td><td> $Stalk[$m] </td><td> $Stalkpct[$m] </td><td> $Sdispo[$m] </td><td> $Sdispopct[$m] </td><td> $Spause[$m] </td><td> $Spausepct[$m] </td><td> $Sdead[$m] </td><td> $Sdeadpct[$m] </td><td> $Scustomer[$m] </td><td> $LoginT   </td><td> $LogoutT </td><td>	$ACHt	  </td>    $SstatusesHTML</tr>";
				}
			else
				{
					$Toutput = "<tr><td> $Sname[$m] </td><td> $Suser[$m] </td><td> $Scalls[$m] </td><td> $StimeTC[$m]$TCuserAUTOLOGOUT</td><td> $Stime[$m] </td><td>$park_AGENT_INFO $Swait[$m] </td><td> $Swaitpct[$m] </td><td> $Stalk[$m] </td><td> $Stalkpct[$m] </td><td> $Sdispo[$m] </td><td> $Sdispopct[$m] </td><td> $Spause[$m] </td><td> $Spausepct[$m] </td><td> $Sdead[$m] </td><td> $Sdeadpct[$m] </td><td> $Scustomer[$m] </td><td> $LoginT   </td><td> $LogoutT   </td><td>    $ACHt	  </td>$SstatusesHTML </tr>";
...
#		echo "$Suser[$m]|$Sname[$m]|$Swait[$m]|$Stalk[$m]|$Sdispo[$m]|$Spause[$m]|$Scalls[$m]\n";
	...
	if ($file_download < 1)
		{
		$ASCII_text.="<tr>";
		$ASCII_text.="<td colspan=\"2\"> "._QXZ("TOTALS",10)." "._QXZ("AGENTS",9,"r").":$hTOT_AGENTS           </td><td> $hTOTcalls </td><td> $hTOTtimeTC </td><td> $hTOTALtime </td><td> $park_TOTALS$hTOTwait </td><td> $hTOTwaitpct </td><td> $hTOTtalk </td><td>$hTOTtalkpct </td><td>$hTOTdispo </td><td> $hTOTdispopct </td><td> $hTOTpause </td><td> $hTOTpausepct </td><td> $hTOTdead </td><td> $hTOTdeadpct </td><td> $hTOTcustomer </td><td> 00:00:00    </td><td>00:00:00    </td><td>00:00:00    </td>   $SUMstatusesHTML\n";
		$ASCII_text.="</tr>";
		if ($AUTOLOGOUTflag > 0)
			{
