<?php include('connection.php'); 
 ...
 $sel = mysql_query("Select Category1,Category2,Category3,Category4,Field1,Field2,Field3,Field4 from call_master where ClientId = '4'and emailSend is null "); 
$text ='My report fields are[tag1]Serial no1[/tag1][tag1]Product Id[/tag1][tag]Category1[/tag][tag]Category2[/tag][tag]Category3[/tag][tag]Category4[/tag]';
$i =0; 
...
file_put_contents( $filename, $text); 
 $ReceiverEmail=array('Email'=>'chandresh.tripathi@teammas.in','Name'=>'chandresh.tripathi@teammas.in'); 
 ...
 $EmailText .="<table><tr><td style=\"padding-left:12px;\">Hello chandresh.tripathi@teammas.in</td></tr>"; 
