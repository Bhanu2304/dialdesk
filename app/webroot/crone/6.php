<?php include('connection.php'); 
 ...
 $sel = mysql_query("Select  from call_master where ClientId = '4'and emailSend is null "); 
$text ='[tag1]Emails[/tag1][tag1]Product Id[/tag1][tag1]Product Id[/tag1][tag1]Product Id[/tag1]';
$i =0; 
