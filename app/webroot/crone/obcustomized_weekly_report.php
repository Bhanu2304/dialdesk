...
include('customized_ob_function.php');

$select = "SELECT * FROM obreportmatrix_master WHERE IF(report_type='weekly' AND LOWER(DAYNAME(CURDATE()))=report_value,TRUE,FALSE)";
