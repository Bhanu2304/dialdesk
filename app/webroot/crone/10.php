<?php include('connection.php'); 
 ...
 $sel = mysql_query("Select Category1,Category2,Field1,Field2 from call_master where ClientId = '4'and emailSend is null "); 
$text ='email fomr[tag1][/tag1][tag1]Serial no1[/tag1][tag1]Product Id[/tag1][tag]Category1[/tag][tag]Category2[/tag]';
$i =0; 
...
file_put_contents( $filename, $text); 
 $ReceiverEmail=array('Email'=>'parveen.kumar@teammas.in','Name'=>'parveen.kumar@teammas.in'); 
 ...
 $EmailText .="<table><tr><td style=\"padding-left:12px;\">Hello parveen.kumar@teammas.in</td></tr>"; 
